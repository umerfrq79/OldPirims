          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              ...
              <div class="card-tools">
                <?php
                echo '<a href="'.base_url().$pageTitle[0]->url.'/add'.'" class="btn btn-primary"><i class="fa fa-plus"></i> New Registration</a>';
                ?>
              </div>
            </div>
            <!-- /.card-header -->
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select <?php if($myAction == 'view'){echo 'disabled';}?> class="form-control select2 " id="<?php echo @$column; ?>" name="<?php echo @$column; ?>">
                            ...
                            if(!empty($companies))
                            {
                                ...
                                {
                                    ?>
                                    <option data-address="<?php echo $company->companyAddress ?>" value="<?php echo $company->companyUniqueNo ?>" <?php if($company->companyUniqueNo == @$recordsEdit[0]->$column){ echo 'selected'; } ?>><?php echo $company->companyName.' -'.$company->licenseNoManual.'- (<small>'.$company->companyAddress.'</small>)'; ?></option>
                                    <?php
                                }
                            }
                            ?>
                ...
                <div class="col-md-6 d-none">
                    <div class="form-group">
                        ...
                        <textarea readonly  id="<?php echo @$column; ?>" class="form-control" rows="3"></textarea>
                    </div>
                </div>
              <!--<div class="col-md-6">
                <div class="form-group">
