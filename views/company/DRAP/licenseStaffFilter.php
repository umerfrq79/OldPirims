                            ...
                            <div class="col-md-12">
                                <form action="<?php echo base_url(); ?>importregistration/lookup" method="post" >
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 sectionfilter">
                                            <div class="form-group">
                                                ...
                                                <select style="height: inherit" autofocus class="form-control select2" id="<?php echo @$column; ?>" name="<?php echo @$column; ?>">
                                                    ...
                                                    if(!empty($sections))
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <option value="<?php echo $section->id ?>" <?php echo isset($sectionId) && $sectionId == $section->id?'selected':''; ?> ><?php echo $section->sectionName; ?></option>
                                                            <?php
                                                        }
                                                    }
                                                    ?>
                  ...
                  <tr <?php if(!(in_array($this->session->userdata('userId'), $seenBy))){echo "style='background-color: #92a1ad2e !important; font-weight:bold;'";} ?>>
                    ...
                    <td class="text-center widthMaxContent">
                      <div class="btn-group">
                          ...
                          <?php } ?>
                        <a target="_blank" href="<?php echo base_url().'newlicense/view/'.$record->id; ?>" class="btn btn-success"><i class="fa fa-eye"></i></a>
