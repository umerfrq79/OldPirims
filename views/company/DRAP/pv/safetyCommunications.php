                ...
                <div class="card card-secondary border-secondary card-tabs" style="border: 3px solid;">
                  <div class="card-header p-0 pt-1">
                    <ul class="nav nav-tabs">
                      <li class="nav-item">
                        <a class="nav-link active" data-toggle="pill" href="#tab1">Safety Communication Details</a>
                      </li>
                      ...
                      <div class="tab-pane fade show active" id="tab1">
                        ...
                        <div class="row" style="float: left; width: 100%;">
                          ...
                          <div class="col-md-6" <?php if($this->roleId <> 26){echo 'style="display:none;"';}?>>
                            <div class="form-group">
                              <?php $label = 'Issued Communication as per GVP guidelines'; ?>
                              ...
                              <?php $column = 'issuedCommunication'; ?>
