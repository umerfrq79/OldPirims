<?php
if($records[0]->registrationStatus <> 'Draft' && $records[0]->registrationStatus <> 'Referred Back To Company (Editable)' && $records[0]->registrationStatus <> 'Referred Back To Company (Locked)' && $records[0]->isDeleted <> 1){
  //if($this->userId <> 27){
...
<head>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-xs-12">
          <!-- col 12 -->
          <form action="<?php echo base_url().substr($pageTitle[0]->url, 0, strcspn($pageTitle[0]->url, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')).'Update'; ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            <div class="box box-default">
              ...
              <div class="box-body">
                <!-- box body -->
                <?php
                if($records[0]->registrationStatus == 'Draft'){
                  echo '
                  <div class="row">
                  <div class="col-xs-4">
                  </div>
                ...
                if($records[0]->registrationStatus == 'Submitted' || $records[0]->registrationStatus == 'Screening' || $records[0]->registrationStatus == 'Under R and I' || $records[0]->registrationStatus == 'Received By DRAP' || $records[0]->registrationStatus == 'Referred Back To Company (Editable)'){
                  echo '
                  <div class="row">
                  <div class="col-xs-4">
                  </div>
                  <div class="col-xs-4">
                    <i class="fa fa-circle" style="color: #4caf50; border-radius: 50%; box-shadow: 0px 0px 20px 0px #FF5722;"></i>
                    ...
                    <i class="fa fa-circle" style="color: #4caf50; border-radius: 50%; box-shadow: 0px 0px 20px 0px #3f51b5;"></i>
                    <i class="fa fa-minus"></i>
                    <i class="fa fa-minus"></i>
                    <i class="fa fa-minus"></i>
                    <i class="fa fa-minus"></i>
                ...
                if($records[0]->registrationStatus == 'Under Review Stage 1' || $records[0]->registrationStatus == 'Under Review Stage 2' || $records[0]->registrationStatus == 'Under Inspection' || $records[0]->registrationStatus == 'Review Complete' || $records[0]->registrationStatus == 'Referred Back To Company (Locked)'){
                  echo '
                  <div class="row">
                  <div class="col-xs-4">
                  </div>
                  <div class="col-xs-4">
                    ...
                    <i class="fa fa-circle" style="color: #4caf50; border-radius: 50%; box-shadow: 0px 0px 20px 0px #3f51b5;"></i>
                    <i class="fa fa-minus"></i><i class="fa fa-minus"></i><i class="fa fa-minus"></i><i class="fa fa-minus"></i><i class="fa fa-minus"></i><i class="fa fa-minus"></i><i class="fa fa-minus"></i>
                    <i class="fa fa-circle" style="color: #4caf50; border-radius: 50%; box-shadow: 0px 0px 20px 0px #795548;"></i>
                    <i class="fa fa-minus"></i>
                    <i class="fa fa-minus"></i>
                    <i class="fa fa-minus"></i>
                    <i class="fa fa-minus"></i>
                ...
                if($records[0]->registrationStatus == 'Under Board Stage 3' || $records[0]->registrationStatus == 'Recommended By Board Stage 4' || $records[0]->registrationStatus == 'Pricing Complete' || $records[0]->registrationStatus == 'Approved'){
                  echo '
                  <div class="row">
                  <div class="col-xs-4">
                  </div>
                  <div class="col-xs-4">
                    ...
                    <i class="fa fa-circle" style="color: #4caf50; border-radius: 50%; box-shadow: 0px 0px 20px 0px #795548;"></i>
                    <i class="fa fa-minus"></i><i class="fa fa-minus"></i><i class="fa fa-minus"></i><i class="fa fa-minus"></i><i class="fa fa-minus"></i><i class="fa fa-minus"></i><i class="fa fa-minus"></i>
                    <i class="fa fa-circle" style="color: #4caf50; border-radius: 50%; box-shadow: 0px 0px 20px 0px #009688;"></i>
                  </div>
                  <div class="col-xs-4">
                  </div>
                </div>
                ...
                <div class="row">
                        ...
                        <div class="col-md-12">
                          <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs" style="background-color: #f1f1f1;">
                              ...
                              <li><a href="#tab_99" data-toggle="tab"><?php if($records[0]->registrationFormType == 'Form 5F (CTD)'){echo 'Form 5F (CTD)';} ?></a></li>
                              <li><a href="#tab_3" data-toggle="tab">Document Submission (CTD)</a></li>
                              <!-- <li><a href="#tab_4" data-toggle="tab">Fee Challan</a></li> -->
                              <li><a href="#tab_5" data-toggle="tab">Queries</a></li>
                            </ul>
                            <div class="tab-content" style="background-color: #f7f7f7 !important; border: 4px solid #bdbdbd !important;">
                              <div class="tab-pane active" id="tab_1" style="background-color: #f7f7f7 !important;">
                                ...
                                <div class="col-xs-12">
                                  ...
                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      <label><i class="fa fa-asterisk text-danger"></i> Manufacturer</label>
                                        <select disabled class="form-control select2" id="manufacturerId" name="">
                                          ...
                                          <?php
                                            if(!empty($manufacturer))
                                            {
                                              ...
                                              {
                                                  ?>
                                                  <option value="<?php echo $record->id ?>" <?php if($record->id == $records[0]->manufacturerId){ echo 'selected'; } ?>><?php echo $record->companyName.' ('.$record->siteAddress.')' ?></option>
                                                  <?php
                                              }
                                            }
                                          ?>
                                  ...
                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      <label>Product Category</label>
                                        <select disabled class="form-control select2" id="productCategoryId" name="">
                                          ...
                                          <?php
                                            if(!empty($productCategory))
                                            {
                                              ...
                                              {
                                                  ?>
                                                  <option value="<?php echo $record->id ?>" <?php if($record->id == $records[0]->productCategoryId){ echo 'selected'; } ?>><?php echo $record->productCategory ?></option>
                                                  <?php
                                              }
                                            }
                                          ?>
                                  ...
                                  <input type="hidden" name="" value="<?php echo $records[0]->id ?>">
                                        ...
                                        <select class="form-control select2" id="registrationTypeId" name="registrationTypeId">
                                          ...
                                          <?php
                                            if(!empty($registrationType))
                                            {
                                              ...
                                              {
                                                if($records[0]->productCategoryId == 1){
                                                  if($record->id == 1 || $record->id == 2){
                                                    continue;
                                                  }
                                                }
                                                if($records[0]->productCategoryId == 2){
                                                  if($record->id == 39 || $record->id == 40 || $record->id == 41 || $record->id == 42 || $record->id == 43 || $record->id == 44 || $record->id == 45 || $record->id == 46){
                                                    continue;
                                                  }
                                                }
                                                  ?>
                                                  <option value="<?php echo $record->id ?>" <?php if($record->id == $records[0]->registrationTypeId){ echo 'selected'; } ?>><?php echo $record->registrationSubType ?></option>
                                                  <?php
                                              }
                                            }
                                          ?>
                                  ...
                                  <input type="hidden" name="" value="<?php if($records[0]->companySubCategory == 'Manufacturer'){echo '1';} if($records[0]->companySubCategory == 'Importer'){echo '2';} ?>">

                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      <label>Used For</label>
                                        <select disabled class="form-control select2" id="usedForId" name="">
                                          ...
                                          <?php
                                            if(!empty($usedFor))
                                            {
                                              ...
                                              {
                                                  ?>
                                                  <option value="<?php echo $record->id ?>" <?php if($record->id == $records[0]->usedForId){ echo 'selected'; } ?>><?php echo $record->usedFor ?></option>
                                                  <?php
                                              }
                                            }
                                          ?>
                                  ...
                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      <label>Registration Form Type</label>
                                        <select class="form-control select2" id="registrationFormType" name="registrationFormType">
                                          <option value="0" <?php if('0' == $records[0]->registrationFormType){ echo 'selected'; } ?>>Select Registration Form Type</option>
                                          <?php if($records[0]->usedForId == 1){?>
                                          <option value="Form 5F (CTD)" <?php if('Form 5F (CTD)' == $records[0]->registrationFormType){ echo 'selected'; } ?>>Form 5F (CTD)</option>
                                          <?php }?>
                                          <?php if($records[0]->productCategoryId == 1 && $records[0]->usedForId == 3){?>
                                          <option value="Form 5" <?php if('Form 5' == $records[0]->registrationFormType){ echo 'selected'; } ?>>Form 5</option>
                                          <option value="Form 5-D" <?php if('Form 5-D' == $records[0]->registrationFormType){ echo 'selected'; } ?>>Form 5-D</option>
                                          <option value="Form 5-E" <?php if('Form 5-E' == $records[0]->registrationFormType){ echo 'selected'; } ?>>Form 5-E</option>
                                          <?php }?>
                                          <?php if($records[0]->productCategoryId == 2 && $records[0]->usedForId == 3){?>
                                          <option value="Form 5-A" <?php if('Form 5-A' == $records[0]->registrationFormType){ echo 'selected'; } ?>>Form 5-A</option>
                                          <?php }?>
                                        </select>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      <label><i class="fa fa-asterisk text-danger"></i> Deposit Date</label>
                                      <input type="date" id="rgDate" name="rgDate" value="<?php echo $records[0]->rgDate; ?>" class="form-control required">
                                    </div>
                                  </div>

                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      <label><i class="fa fa-asterisk text-danger"></i> Fee Challan Invoice No.</label>
                                      <input type="text" id="rgInvoiceNo" name="rgInvoiceNo" value="<?php echo $records[0]->rgInvoiceNo; ?>" class="form-control required">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      ...
                                      <input type="number" id="rgFeeAmount" name="rgFeeAmount" value="<?php echo $records[0]->rgFeeAmount; ?>" class="form-control required">
                                    </div>
                                  </div>

                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      <label>Covering Letter <i>[<font style="color: #F44336;">File Format</font><font style="color: #3f51b5;"> (*.JPEG, *.PNG, *.PDF)</font><font style="color: #F44336;"> Max. File Size</font><font style="color: #3f51b5;"> 5 MB</font>]</i></label>
                                      <input type="file" id="rgCoverLetter" name="rgCoverLetter" value="<?php echo $records[0]->atcCodeManual; ?>">
                                    </div>
                                  </div>

                                  <div class="col-xs-6">
                                  <div class="form-group">
                                    <label>Covering Letter Link</label>
                                    <br>
                                    <a <?php if(!$records[0]->rgCoverLetter){ echo 'disabled';} ?> <?php if($records[0]->rgCoverLetter){ echo 'href="'.base_url().'uploads/company/'.$this->companyUniqueNo.'/Registration/'.$records[0]->rgCoverLetter.'"';} ?> target="_blank" class="btn btn-success"><i class="fa fa-file-o"></i></a>
                                  </div>
                                  </div>
                                  ...
                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      ...
                                      <input type="file" id="rgFeeChallan" name="rgFeeChallan" value="<?php echo $records[0]->atcCodeManual; ?>">
                                    </div>
                                  </div>

                                  <div class="col-xs-6">
                                  <div class="form-group">
                                    <label>Fee Challan Link</label>
                                    <br>
                                    <a <?php if(!$records[0]->rgFeeChallan){ echo 'disabled';} ?> <?php if($records[0]->rgFeeChallan){ echo 'href="'.base_url().'uploads/company/'.$this->companyUniqueNo.'/Registration/'.$records[0]->rgFeeChallan.'"';} ?> target="_blank" class="btn btn-success"><i class="fa fa-file-o"></i></a>
                                  </div>
                                  </div>
                                ...
                                <div class="col-xs-12">
                                  ...
                                  <div class="col-xs-12">
                                    <div class="box">
                                      ...
                                      <div class="box-header bg-gray">
                                        <h3 class="box-title">Proposed Brand Name (Without strength)</h3>
                                      </div>
                                      <!-- /.box-header -->
                                      <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                        ...
                                        <table id="tabledetailproposedname" class="table table-bordered table-striped" width="100%">
                                          ...
                                          <tbody>
                                            <?php $sn=1; ?>
                                            <?php
                                            if(empty($recordsDetailProposedName))
                                            {
                                            ?>
                                            <tr>
                                              <td><?=$sn?>.<input type="hidden" id="tabledetailproposedname-id_<?=$sn?>" name="tabledetailproposedname-id_detail[]" value="<?=$sn?>"></td>
                                              <td>
                                                <input type="text" onkeypress="return /[a-z]/i.test(event.key)" id="tabledetailproposedname-proposedName_<?=$sn?>" name="tabledetailproposedname-proposedName_detail[]" value="" class="form-control required">
                                              </td>
                                            ...
                                            if(!empty($recordsDetailProposedName))
                                            {
                                                foreach($recordsDetailProposedName as $detail)
                                                {
                                            ?>
                                            <tr>
                                              <td><?=$sn?>.<input type="hidden" id="tabledetailproposedname-id_<?=$sn?>" name="tabledetailproposedname-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                              <td>
                                                <input type="text" onkeypress="return /[a-z]/i.test(event.key)" id="tabledetailproposedname-proposedName_<?=$sn?>" name="tabledetailproposedname-proposedName_detail[]" value="<?php echo $detail->proposedName; ?>" class="form-control required">
                                              </td>
                                              <td class="text-center widthMaxContent">
                                                <div class="btn-group">
                                                  <i class="btn btn-primary fa fa-plus"></i>
                                  ...
                                  <div class="col-xs-3">
                                    <div class="form-group">
                                      ...
                                      <input type="text" id="strength" name="strength" value="<?php echo $records[0]->strength; ?>" class="form-control required">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-xs-3">
                                    <div class="form-group">
                                      ...
                                      <input type="text" id="unit" name="unit" value="<?php echo $records[0]->unit; ?>" class="form-control required">
                                    </div>
                                  </div>

                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      <label><i class="fa fa-asterisk text-danger"></i> Common Name</label>
                                      <input type="text" id="rgCommonName" name="rgCommonName" value="<?php echo $records[0]->rgCommonName; ?>" class="form-control required">
                                    </div>
                                  </div>
                                        ...
                                        <select class="form-control select2" id="pharmacopeiaId" name="pharmacopeiaId">
                                          ...
                                          <?php
                                            if(!empty($pharmacopeia))
                                            {
                                              ...
                                              {
                                                  ?>
                                                  <option value="<?php echo $record->id ?>" <?php if($record->id == $records[0]->pharmacopeiaId){ echo 'selected'; } ?>><?php echo $record->pharmacopeia ?></option>
                                                  <?php
                                              }
                                            }
                                          ?>
                                      ...
                                      <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                        ...
                                        <table id="tabledetailinncode" class="table table-bordered table-striped" width="100%">
                                          ...
                                          <tbody>
                                            ...
                                            if(!empty($recordsDetailINNCode))
                                            {
                                                foreach($recordsDetailINNCode as $detail)
                                                {
                                            ?>
                                            <tr>
                                              <td><?=$sn?>.<input type="hidden" id="tabledetailinncode-id_<?=$sn?>" name="tabledetailinncode-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                              <td>
                                                <select class="form-control select2" id="tabledetailinncode-innCodeId_<?=$sn?>" name="tabledetailinncode-innCodeId_detail[]">
                                                  <option value="0">Select INN Code</option>
                                                  <?php
                                                    if(!empty($innCode))
                                                    {
                                                      ...
                                                      {
                                                          ?>
                                                          <option value="<?php echo $record->id ?>" <?php if($record->id == $detail->innCodeId){ echo 'selected'; } ?>><?php echo $record->atcName ?></option>
                                                          <?php
                                                      }
                                                    }
                                                  ?>
                                              ...
                                              <td>
                                                <input type="text" id="tabledetailinncode-strength_<?=$sn?>" name="tabledetailinncode-strength_detail[]" value="<?php echo $detail->strength; ?>" class="form-control required">
                                              </td>
                                              <td>
                                                <input type="text" id="tabledetailinncode-unit_<?=$sn?>" name="tabledetailinncode-unit_detail[]" value="<?php echo $detail->unit; ?>" class="form-control required">
                                              </td>
                                              <td><a href="<?php echo base_url().'ctdspart/'.$detail->id; ?>" target="_blank" class="btn btn-success" id=""><i class="fa fa-file-text"></i></a></td>
                                              <td class="text-center widthMaxContent">
                                                <div class="btn-group">
                                                  <i class="btn btn-primary fa fa-plus"></i>
                                                  <i class="btn btn-danger fa fa-trash"></i>
                                        ...
                                        <select class="form-control select2" id="atcCodeId" name="atcCodeId">
                                          ...
                                          <?php
                                            if(!empty($atcCode))
                                            {
                                              ...
                                              {
                                                  ?>
                                                  <option value="<?php echo $record->id ?>" <?php if($record->id == $records[0]->atcCodeId){ echo 'selected'; } ?>><?php echo $record->atcName.' ('.$record->atcCode.')' ?></option>
                                                  <?php
                                              }
                                            }
                                          ?>
                                  ...
                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" id="atcCodeManual" name="atcCodeManual" value="<?php echo $records[0]->atcCodeManual; ?>" class="form-control required">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <textarea id="labelClaim" name="labelClaim" class="form-control" rows="3"><?php echo $records[0]->labelClaim; ?></textarea>
                                    </div>
                                  </div>
                                        ...
                                        <select class="form-control select2" id="routeOfAdminId" name="routeOfAdminId">
                                          ...
                                          <?php
                                            if(!empty($routeOfAdmin))
                                            {
                                              ...
                                              {
                                                  ?>
                                                  <option value="<?php echo $record->id ?>" <?php if($record->id == $records[0]->routeOfAdminId){ echo 'selected'; } ?>><?php echo $record->routeOfAdmin ?></option>
                                                  <?php
                                              }
                                            }
                                          ?>
                                        ...
                                        <select class="form-control select2" id="shelfLifeId" name="shelfLifeId">
                                          ...
                                          <?php
                                            if(!empty($shelfLife))
                                            {
                                              ...
                                              {
                                                  ?>
                                                  <option value="<?php echo $record->id ?>" <?php if($record->id == $records[0]->shelfLifeId){ echo 'selected'; } ?>><?php echo $record->shelfLife ?></option>
                                                  <?php
                                              }
                                            }
                                          ?>
                                        ...
                                        <select class="form-control select2" id="storageConditionId" name="storageConditionId">
                                          ...
                                          <?php
                                            if(!empty($storageCondition))
                                            {
                                              ...
                                              {
                                                  ?>
                                                  <option value="<?php echo $record->id ?>" <?php if($record->id == $records[0]->storageConditionId){ echo 'selected'; } ?>><?php echo $record->storageCondition ?></option>
                                                  <?php
                                              }
                                            }
                                          ?>
                                  ...
                                  <div class="col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <textarea id="packingDesc" name="packingDesc" class="form-control" rows="3"><?php echo $records[0]->packingDesc; ?></textarea>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <textarea id="secondaryPackingDesc" name="secondaryPackingDesc" class="form-control" rows="3"><?php echo $records[0]->secondaryPackingDesc; ?></textarea>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" id="innovatorBrand" name="innovatorBrand" value="<?php echo $records[0]->innovatorBrand; ?>" class="form-control required">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" id="innovatorCompany" name="innovatorCompany" value="<?php echo $records[0]->innovatorCompany; ?>" class="form-control required">
                                    </div>
                                  </div>
                                      ...
                                      <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                        ...
                                        <table id="tabledetailproposedprice" class="table table-bordered table-striped" width="100%">
                                          ...
                                          <tbody>
                                            <?php $sn=1; ?>
                                            <?php
                                            if(empty($recordsDetailProposedPrice))
                                            {
                                            ?>
                                            <tr>
                                            ...
                                            if(!empty($recordsDetailProposedPrice))
                                            {
                                                foreach($recordsDetailProposedPrice as $detail)
                                                {
                                            ?>
                                            <tr>
                                              <td><?=$sn?>.<input type="hidden" id="tabledetailproposedprice-id_<?=$sn?>" name="tabledetailproposedprice-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                              <td>
                                                <input type="text" id="tabledetailproposedprice-packSize_<?=$sn?>" name="tabledetailproposedprice-packSize_detail[]" value="<?php echo $detail->packSize; ?>" class="form-control required">
                                              </td>
                                              <td>
                                                <input type="text" id="tabledetailproposedprice-proposedPrice_<?=$sn?>" name="tabledetailproposedprice-proposedPrice_detail[]" value="<?php echo $detail->proposedPrice; ?>" class="form-control required">
                                              </td>
                                              <td>
                                                <input type="text" id="tabledetailproposedprice-shelfLife_<?=$sn?>" name="tabledetailproposedprice-shelfLife_detail[]" value="<?php echo $detail->shelfLife; ?>" class="form-control required">
                                              </td>
                                              <td class="text-center widthMaxContent">
                                                <div class="btn-group">
                                                  <i class="btn btn-primary fa fa-plus"></i>
                                  ...
                                  <div class="col-xs-3">
                                    <div class="form-group">
                                      ...
                                      <input type="hidden" id="proposedArtworkPathHidden" name="proposedArtworkPath" value="<?php echo $records[0]->proposedArtworkPath; ?>">
                                  ...
                                  <div class="col-xs-3">
                                    <div class="form-group">
                                      <label>Proposed Artwork Link</label>
                                      <br>
                                      <a <?php if(!$records[0]->proposedArtworkPath){ echo 'disabled';} ?> <?php if($records[0]->proposedArtworkPath){ echo 'href="'.base_url().'uploads/company/'.$this->companyUniqueNo.'/Registration/'.$records[0]->proposedArtworkPath.'"';} ?> target="_blank" class="btn btn-success"><i class="fa fa-file-o"></i></a>
                                    </div>
                                  </div>
                                        ...
                                        <select class="form-control select2" id="intendedMarketId" name="intendedMarketId">
                                          ...
                                          <?php
                                            if(!empty($intendedMarket))
                                            {
                                              ...
                                              {
                                                  ?>
                                                  <option value="<?php echo $record->id ?>" <?php if($record->id == $records[0]->intendedMarketId){ echo 'selected'; } ?>><?php echo $record->intendedMarket ?></option>
                                                  <?php
                                              }
                                            }
                                          ?>
                                    ...
                                    <div class="form-group">
                                      <label><i class="fa fa-asterisk text-danger"></i> Intended Population</label>
                                        <select class="form-control select2" id="intendedPopulation" name="intendedPopulation">
                                          <option value="0" <?php if('0' == $records[0]->intendedPopulation){ echo 'selected'; } ?>>Select Intended Population</option>
                                          <option value="Adult Male Only" <?php if('Adult Male Only' == $records[0]->intendedPopulation){ echo 'selected'; } ?>>Adult Male Only</option>
                                          <option value="Adult Female Only" <?php if('Adult Female Only' == $records[0]->intendedPopulation){ echo 'selected'; } ?>>Adult Female Only</option>
                                          <option value="Adult" <?php if('Adult' == $records[0]->intendedPopulation){ echo 'selected'; } ?>>Adult</option>
                                          <option value="Children" <?php if('Children' == $records[0]->intendedPopulation){ echo 'selected'; } ?>>Children</option>
                                          <option value="Infant" <?php if('Infant' == $records[0]->intendedPopulation){ echo 'selected'; } ?>>Infant</option>
                                        </select>
                                    </div>
                                  </div>
                                    ...
                                    <div class="form-group">
                                      <label><i class="fa fa-asterisk text-danger"></i> Intended Age Group</label>
                                        <select class="form-control select2" id="intendedAgeGroup" name="intendedAgeGroup">
                                          <option value="0" <?php if('0' == $records[0]->intendedAgeGroup){ echo 'selected'; } ?>>Select Intended Age Group</option>
                                          <option value="3 Months To 5 Months" <?php if('3 Months To 5 Months' == $records[0]->intendedAgeGroup){ echo 'selected'; } ?>>3 Months To 5 Months</option>
                                          <option value="6 Months To 11 Months" <?php if('6 Months To 11 Months' == $records[0]->intendedAgeGroup){ echo 'selected'; } ?>>6 Months To 11 Months</option>
                                          <option value="1 Year To 3 Years" <?php if('1 Year To 3 Years' == $records[0]->intendedAgeGroup){ echo 'selected'; } ?>>1 Year To 3 Years</option>
                                          <option value="4 Years To 5 Years" <?php if('4 Years To 5 Years' == $records[0]->intendedAgeGroup){ echo 'selected'; } ?>>4 Years To 5 Years</option>
                                          <option value="6 Years To 11 Years" <?php if('6 Years To 11 Years' == $records[0]->intendedAgeGroup){ echo 'selected'; } ?>>6 Years To 11 Years</option>
                                          <option value="12 Years To 19 Years" <?php if('12 Years To 19 Years' == $records[0]->intendedAgeGroup){ echo 'selected'; } ?>>12 Years To 19 Years</option>
                                          <option value="20 Years To 39 Years" <?php if('20 Years To 39 Years' == $records[0]->intendedAgeGroup){ echo 'selected'; } ?>>20 Years To 39 Years</option>
                                          <option value="40 Years To 59 Years" <?php if('40 Years To 59 Years' == $records[0]->intendedAgeGroup){ echo 'selected'; } ?>>40 Years To 59 Years</option>
                                          <option value="60 Years To 79 Years" <?php if('60 Years To 79 Years' == $records[0]->intendedAgeGroup){ echo 'selected'; } ?>>60 Years To 79 Years</option>
                                          <option value="80 Years To 99 Years" <?php if('80 Years To 99 Years' == $records[0]->intendedAgeGroup){ echo 'selected'; } ?>>80 Years To 99 Years</option>
                                        </select>
                                    </div>
                                  </div>
                                        ...
                                        <select class="form-control select2" id="manufacturerId" name="manufacturerId">
                                          ...
                                          <?php
                                            if(!empty($manufacturer))
                                            {
                                              ...
                                              {
                                                  ?>
                                                  <option value="<?php echo $record->id ?>" <?php if($record->id == $records[0]->manufacturerId){ echo 'selected'; } ?>><?php echo $record->companyName ?></option>
                                                  <?php
                                              }
                                            }
                                          ?>
                                  ...
                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" id="manufacturerManual" name="manufacturerManual" value="<?php echo $records[0]->manufacturerManual; ?>" class="form-control required">
                                    </div>
                                  </div>
                                        ...
                                        <select class="form-control select2" id="countryId" name="countryId">
                                          ...
                                          <?php
                                            if(!empty($country))
                                            {
                                              ...
                                              {
                                                  ?>
                                                  <option value="<?php echo $record->id ?>" <?php if($record->id == $records[0]->countryId){ echo 'selected'; } ?>><?php echo $record->countryName ?></option>
                                                  <?php
                                              }
                                            }
                                          ?>
                                      ...
                                      <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                        ...
                                        <table id="tabledetaildomesticreference" class="table table-bordered table-striped" width="100%">
                                          ...
                                          <tbody>
                                            <?php $sn=1; ?>
                                            <?php
                                            if(empty($recordsDetailDomesticReference))
                                            {
                                            ?>
                                            <tr>
                                              <td><?=$sn?>.<input type="hidden" id="tabledetaildomesticreference-id_<?=$sn?>" name="tabledetaildomesticreference-id_detail[]" value="<?=$sn?>"></td>
                                              <td>
                                                <input type="text" id="tabledetaildomesticreference-proposedPrice_<?=$sn?>" name="tabledetaildomesticreference-brandName_detail[]" value="" class="form-control required">
                                              </td>
                                              <td>
                                                <input type="text" id="tabledetaildomesticreference-proposedPrice_<?=$sn?>" name="tabledetaildomesticreference-registrationNo_detail[]" value="" class="form-control required">
                                              </td>
                                              <td>
                                                <input type="text" id="tabledetaildomesticreference-proposedPrice_<?=$sn?>" name="tabledetaildomesticreference-productHolder_detail[]" value="" class="form-control required">
                                              </td>
                                              <td class="text-center widthMaxContent">
                                                <div class="btn-group">
                                                  <i class="btn btn-primary fa fa-plus"></i>
                                            ...
                                            if(!empty($recordsDetailDomesticReference))
                                            {
                                                foreach($recordsDetailDomesticReference as $detail)
                                                {
                                            ?>
                                            <tr>
                                              <td><?=$sn?>.<input type="hidden" id="tabledetaildomesticreference-id_<?=$sn?>" name="tabledetaildomesticreference-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                              <td>
                                                <input type="text" id="tabledetaildomesticreference-brandName_<?=$sn?>" name="tabledetaildomesticreference-brandName_detail[]" value="<?php echo $detail->brandName; ?>" class="form-control required">
                                              </td>
                                              <td>
                                                <input type="text" id="tabledetaildomesticreference-registrationNo_<?=$sn?>" name="tabledetaildomesticreference-registrationNo_detail[]" value="<?php echo $detail->registrationNo; ?>" class="form-control required">
                                              </td>
                                              <td>
                                                <input type="text" id="tabledetaildomesticreference-productHolder_<?=$sn?>" name="tabledetaildomesticreference-productHolder_detail[]" value="<?php echo $detail->productHolder; ?>" class="form-control required">
                                              </td>
                                              <td class="text-center widthMaxContent">
                                                <div class="btn-group">
                                                  <i class="btn btn-primary fa fa-plus"></i>
                                      ...
                                      <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                        ...
                                        <table id="tabledetailinternationalreference" class="table table-bordered table-striped" width="100%">
                                          ...
                                          <tbody>
                                            <?php $sn=1; ?>
                                            <?php
                                            if(empty($recordsDetailInternationalReference))
                                            {
                                            ?>
                                            <tr>
                                            ...
                                            if(!empty($recordsDetailInternationalReference))
                                            {
                                                foreach($recordsDetailInternationalReference as $detail)
                                                {
                                            ?>
                                            <tr>
                                              <td><?=$sn?>.<input type="hidden" id="tabledetailinternationalreference-id_<?=$sn?>" name="tabledetailinternationalreference-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                              <td>
                                                <input type="text" id="tabledetailinternationalreference-brandName_<?=$sn?>" name="tabledetailinternationalreference-brandName_detail[]" value="<?php echo $detail->brandName; ?>" class="form-control required">
                                              </td>
                                              <td>
                                                <input type="text" id="tabledetailinternationalreference-productHolder_<?=$sn?>" name="tabledetailinternationalreference-productHolder_detail[]" value="<?php echo $detail->productHolder; ?>" class="form-control required">
                                              </td>
                                              <td>
                                                <input type="text" id="tabledetailinternationalreference-regulatingBody_<?=$sn?>" name="tabledetailinternationalreference-regulatingBody_detail[]" value="<?php echo $detail->regulatingBody; ?>" class="form-control required">
                                              </td>
                                              <td class="text-center widthMaxContent">
                                                <div class="btn-group">
                                                  <i class="btn btn-primary fa fa-plus"></i>
                                      ...
                                      <div id="selectable-output">
                                        <div class="box-body" style="display:none;" id="div_1">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_1" name="folderData1" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData1; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_2">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_2" name="folderData2" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData2; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_3">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_3" name="folderData3" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData3; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_4">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_4" name="folderData4" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData4; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_5">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_5" name="folderData5" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData5; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_6">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_6" name="folderData6" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData6; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_7">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_7" name="folderData7" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData7; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_8">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_8" name="folderData8" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData8; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_9">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_9" name="folderData9" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData9; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_10">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_10" name="folderData10" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData10; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_11">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_11" name="folderData11" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData11; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_12">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_12" name="folderData12" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData12; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_13">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_13" name="folderData13" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData13; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_14">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_14" name="folderData14" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData14; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_15">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_15" name="folderData15" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData15; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_16">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_16" name="folderData16" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData16; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_17">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_17" name="folderData17" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData17; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_18">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_18" name="folderData18" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData18; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_19">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_19" name="folderData19" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData19; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_20">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_20" name="folderData20" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData20; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_21">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_21" name="folderData21" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData21; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_22">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_22" name="folderData22" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData22; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_23">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_23" name="folderData23" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData23; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_24">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_24" name="folderData24" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData24; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_25">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_25" name="folderData25" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData25; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_26">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_26" name="folderData26" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData26; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_27">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_27" name="folderData27" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData27; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_28">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_28" name="folderData28" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData28; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_29">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_29" name="folderData29" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData29; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_30">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_30" name="folderData30" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData30; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_32">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_32" name="folderData32" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData32; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_33">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_33" name="folderData33" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData33; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_34">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_34" name="folderData34" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData34; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_35">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_35" name="folderData35" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData35; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_36">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_36" name="folderData36" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData36; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_37">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_37" name="folderData37" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData37; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_38">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_38" name="folderData38" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData38; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_39">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_39" name="folderData39" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData39; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_40">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_40" name="folderData40" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData40; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_41">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_41" name="folderData41" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData41; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_42">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_42" name="folderData42" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData42; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_43">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_43" name="folderData43" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData43; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_44">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_44" name="folderData44" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData44; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_45">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_45" name="folderData45" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData45; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_46">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_46" name="folderData46" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData46; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_47">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_47" name="folderData47" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData47; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_48">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_48" name="folderData48" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData48; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_54">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_54" name="folderData54" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData54; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_55">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_55" name="folderData55" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData55; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_56">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_56" name="folderData56" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData56; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_57">
                                            ...
                                            <div class="col-xs-12">
                                              <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="folderData_57" name="folderData57" class="form-control" rows="10" cols="80"><?php echo $recordsCTD[0]->folderData57; ?></textarea>
                                              </div>
                                            </div>
                                          </div>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailsummary" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Non-proprietary name(s) of the Drug Product" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="innValue" name="innValue" value="<?php echo $recordsCTD[0]->innValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Proprietary name(s) of the Drug Product" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="brandNameValue" name="brandNameValue" value="<?php echo $recordsCTD[0]->brandNameValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="International non-proprietary name(s) of the Drug Substance, including form (salt, hydrate, polymorph)" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="innSubstanceValue" name="innSubstanceValue" value="<?php echo $recordsCTD[0]->innSubstanceValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Applicant name and address " class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="applicantNameValue" name="applicantNameValue" value="<?php echo $recordsCTD[0]->applicantNameValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Dosage form" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="dosageFormValue" name="dosageFormValue" value="<?php echo $recordsCTD[0]->dosageFormValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Strength" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="strengthValue" name="strengthValue" value="<?php echo $recordsCTD[0]->strengthValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Route of administration" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="routeValue" name="routeValue" value="<?php echo $recordsCTD[0]->routeValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Proposed indication(s)" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="indicationValue" name="indicationValue" value="<?php echo $recordsCTD[0]->indicationValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Primary Contact person responsible for this application" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="contactPersonValue" name="contactPersonValue" value="<?php echo $recordsCTD[0]->contactPersonValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Contact person's job title" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="jobTitleValue" name="jobTitleValue" value="<?php echo $recordsCTD[0]->jobTitleValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Corresponding address" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="addressValue" name="addressValue" value="<?php echo $recordsCTD[0]->addressValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Town/City/Country" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="townCityValue" name="townCityValue" value="<?php echo $recordsCTD[0]->townCityValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Contact person's email address" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="emailValue" name="emailValue" value="<?php echo $recordsCTD[0]->emailValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Contact person's phone number" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="phoneValue" name="phoneValue" value="<?php echo $recordsCTD[0]->phoneValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailotherinfo" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        <?php $sn=1; ?>
                                                        <?php
                                                        if(empty($recordsDetailOtherInfo))
                                                        {
                                                        ?>
                                                        <tr>
                                                        ...
                                                        if(!empty($recordsDetailOtherInfo))
                                                        {
                                                            foreach($recordsDetailOtherInfo as $detail)
                                                            {
                                                        ?>
                                                        <tr>
                                                          <td><?=$sn?>.<input type="hidden" id="tabledetailotherinfo-id_<?=$sn?>" name="tabledetailotherinfo-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                                          <td>
                                                            <input type="text" id="tabledetailotherinfo-brandName_<?=$sn?>" name="tabledetailotherinfo-brandName_detail[]" value="<?php echo $detail->brandName; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="date" id="tabledetailotherinfo-submissionDate_<?=$sn?>" name="tabledetailotherinfo-submissionDate_detail[]" value="<?php echo $detail->submissionDate; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailotherinfo-drugSubstance_<?=$sn?>" name="tabledetailotherinfo-drugSubstance_detail[]" value="<?php echo $detail->drugSubstance; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailotherinfo-substanceMfg_<?=$sn?>" name="tabledetailotherinfo-substanceMfg_detail[]" value="<?php echo $detail->substanceMfg; ?>" class="form-control required">
                                                          </td>
                                                          <td class="text-center widthMaxContent">
                                                            <div class="btn-group">
                                                              <i class="btn btn-primary fa fa-plus"></i>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailliterature" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="USP" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <select class="form-control select2" id="monographAPIUSP" name="monographAPIUSP">
                                                              <option value="No" <?php if('No' == $recordsCTD[0]->monographAPIUSP){ echo 'selected'; } ?>>No</option>
                                                              <option value="Yes" <?php if('Yes' == $recordsCTD[0]->monographAPIUSP){ echo 'selected'; } ?>>Yes</option>
                                                            </select>
                                                          </td>
                                                          <td>
                                                            <input type="text" id="editionAPIUSP" name="editionAPIUSP" value="<?php echo $recordsCTD[0]->editionAPIUSP; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="BP" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <select class="form-control select2" id="monographAPIBP" name="monographAPIBP">
                                                              <option value="No" <?php if('No' == $recordsCTD[0]->monographAPIBP){ echo 'selected'; } ?>>No</option>
                                                              <option value="Yes" <?php if('Yes' == $recordsCTD[0]->monographAPIBP){ echo 'selected'; } ?>>Yes</option>
                                                            </select>
                                                          </td>
                                                          <td>
                                                            <input type="text" id="editionAPIBP" name="editionAPIBP" value="<?php echo $recordsCTD[0]->editionAPIBP; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Ph.Eur" class="form-control required">
                                                          </td>
                                                          
                                                          <td>
                                                            <select class="form-control select2" id="monographAPIPhEur" name="monographAPIPhEur">
                                                              <option value="No" <?php if('No' == $recordsCTD[0]->monographAPIPhEur){ echo 'selected'; } ?>>No</option>
                                                              <option value="Yes" <?php if('Yes' == $recordsCTD[0]->monographAPIPhEur){ echo 'selected'; } ?>>Yes</option>
                                                            </select>
                                                          </td>
                                                          <td>
                                                            <input type="text" id="editionAPIPhEur" name="editionAPIPhEur" value="<?php echo $recordsCTD[0]->editionAPIPhEur; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Ph.Int" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <select class="form-control select2" id="monographAPIPhInt" name="monographAPIPhInt">
                                                              <option value="No" <?php if('No' == $recordsCTD[0]->monographAPIPhInt){ echo 'selected'; } ?>>No</option>
                                                              <option value="Yes" <?php if('Yes' == $recordsCTD[0]->monographAPIPhInt){ echo 'selected'; } ?>>Yes</option>
                                                            </select>
                                                          </td>
                                                          <td>
                                                            <input type="text" id="editionAPIPhInt" name="editionAPIPhInt" value="<?php echo $recordsCTD[0]->editionAPIPhInt; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Other (e.g. JP)" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <select class="form-control select2" id="monographAPIOther" name="monographAPIOther">
                                                              <option value="No" <?php if('No' == $recordsCTD[0]->monographAPIOther){ echo 'selected'; } ?>>No</option>
                                                              <option value="Yes" <?php if('Yes' == $recordsCTD[0]->monographAPIOther){ echo 'selected'; } ?>>Yes</option>
                                                            </select>
                                                          </td>
                                                          <td>
                                                            <input type="text" id="editionAPIOther" name="editionAPIOther" value="<?php echo $recordsCTD[0]->editionAPIOther; ?>" class="form-control required">
                                                          </td>
                                                        </tr>
                                                       ...
                                                       <tr>
                                                          ...
                                                          <td>
                                                            <select class="form-control select2" id="monographFPPUSP" name="monographFPPUSP">
                                                              <option value="No" <?php if('No' == $recordsCTD[0]->monographFPPUSP){ echo 'selected'; } ?>>No</option>
                                                              <option value="Yes" <?php if('Yes' == $recordsCTD[0]->monographFPPUSP){ echo 'selected'; } ?>>Yes</option>
                                                            </select>
                                                          </td>
                                                          <td>
                                                            <input type="text" id="editionFPPUSP" name="editionFPPUSP" value="<?php echo $recordsCTD[0]->editionFPPUSP; ?>" class="form-control required">
                                                          </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>
                                                            <select class="form-control select2" id="monographFPPBP" name="monographFPPBP">
                                                              <option value="No" <?php if('No' == $recordsCTD[0]->monographFPPBP){ echo 'selected'; } ?>>No</option>
                                                              <option value="Yes" <?php if('Yes' == $recordsCTD[0]->monographFPPBP){ echo 'selected'; } ?>>Yes</option>
                                                            </select>
                                                          </td>
                                                          <td>
                                                            <input type="text" id="editionFPPBP" name="editionFPPBP" value="<?php echo $recordsCTD[0]->editionFPPBP; ?>" class="form-control required">
                                                          </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>
                                                            <select class="form-control select2" id="monographFPPPhInt" name="monographFPPPhInt">
                                                              <option value="No" <?php if('No' == $recordsCTD[0]->monographFPPPhInt){ echo 'selected'; } ?>>No</option>
                                                              <option value="Yes" <?php if('Yes' == $recordsCTD[0]->monographFPPPhInt){ echo 'selected'; } ?>>Yes</option>
                                                            </select>
                                                          </td>
                                                          <td>
                                                            <input type="text" id="editionFPPPhInt" name="editionFPPPhInt" value="<?php echo $recordsCTD[0]->editionFPPPhInt; ?>" class="form-control required">
                                                          </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>
                                                            <select class="form-control select2" id="monographFPPOther" name="monographFPPOther">
                                                              <option value="No" <?php if('No' == $recordsCTD[0]->monographFPPOther){ echo 'selected'; } ?>>No</option>
                                                              <option value="Yes" <?php if('Yes' == $recordsCTD[0]->monographFPPOther){ echo 'selected'; } ?>>Yes</option>
                                                            </select>
                                                          </td>
                                                          <td>
                                                            <input type="text" id="editionFPPOther" name="editionFPPOther" value="<?php echo $recordsCTD[0]->editionFPPOther; ?>" class="form-control required">
                                                          </td>
                                                        </tr> 
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="<e.g. WHOPARs, EPARs, FDA review, PMDA review report>)" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="monographOtherRef" name="monographOtherRef" value="<?php echo $recordsCTD[0]->monographOtherRef; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="editionOtherRef" name="editionOtherRef" value="<?php echo $recordsCTD[0]->editionOtherRef; ?>" class="form-control required">
                                                          </td>
                                                        </tr>
                                            ...
                                            <div class="col-xs-12">
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="facilityEquipments" name="facilityEquipments" class="form-control" rows="7" placeholder=""><?php echo $recordsCTD[0]->facilityEquipments; ?></textarea>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea readonly id="agentSafetyEval" name="agentSafetyEval" class="form-control" rows="7" placeholder="Optional Part"><?php echo $recordsCTD[0]->agentSafetyEval; ?></textarea>
                                            ...
                                            <div class="col-xs-12">
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="execProductionDoc" name="execProductionDoc" class="form-control" rows="7" placeholder="<Provide copy of Batch Manufacturing Record (BMR) for all the batches of drug product for which stability studies data is provided in Module 3 section 3.2.P.8.3>"><?php echo $recordsCTD[0]->execProductionDoc; ?></textarea>
                          ...
                          "><?php echo $recordsCTD[0]->masterProductionDoc; ?></textarea>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailanalyticalprocsummary" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="HPLC Method Summary" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Volume /Page" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="volumePageValue" name="volumePageValue" value="<?php echo $recordsCTD[0]->volumePageValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Method Name" class="form-control required">
                                                          </td>
                                                          <td colspan="3">
                                                            <input type="text" id="methodNameValue" name="methodNameValue" value="<?php echo $recordsCTD[0]->methodNameValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Method Code" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="methodCodeValue" name="methodCodeValue" value="<?php echo $recordsCTD[0]->methodCodeValue; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Method Date" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="date" id="methodDateValue" name="methodDateValue" value="<?php echo $recordsCTD[0]->methodDateValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Column(s) /Temprature (If other than ambient)" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input type="text" id="columnTempValue" name="columnTempValue" value="<?php echo $recordsCTD[0]->columnTempValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Mobile Phase (Specify gradient program, if applicable)" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input type="text" id="mobilePhaseValue" name="mobilePhaseValue" value="<?php echo $recordsCTD[0]->mobilePhaseValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>
                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Detector (and wavelength, if applicable)" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input type="text" id="detectorValue" name="detectorValue" value="<?php echo $recordsCTD[0]->detectorValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Flow rate" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input type="text" id="flowRateValue" name="flowRateValue" value="<?php echo $recordsCTD[0]->flowRateValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Injection volume" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input type="text" id="injectionVolValue" name="injectionVolValue" value="<?php echo $recordsCTD[0]->injectionVolValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Sample solution preparation and concentration
                            (expressed as mg/ml, let this be termed “A”)" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input type="text" id="sampleSolutionValue" name="sampleSolutionValue" value="<?php echo $recordsCTD[0]->sampleSolutionValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Reference solution preparation and concentration
                            (expressed as mg/ml and as % of “A”)" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input type="text" id="refSolutionValue" name="refSolutionValue" value="<?php echo $recordsCTD[0]->refSolutionValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="System suitability solution concentration
                            (expressed as mg/ml and as % of “A”):" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input type="text" id="sysSuitablityValue" name="sysSuitablityValue" value="<?php echo $recordsCTD[0]->sysSuitablityValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="System suitability tests (tests and acceptance criteria)" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input type="text" id="suitabilityTestValue" name="suitabilityTestValue" value="<?php echo $recordsCTD[0]->suitabilityTestValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Method of quantification (e.g. against API or impurity reference standard(s))" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input type="text" id="quantificationValue" name="quantificationValue" value="<?php echo $recordsCTD[0]->quantificationValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>
                                                        <?php $sn++ ?>
                                                      </tbody>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailvalidationsummary" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Validation Summary" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input type="text" id="volPage1Value" name="volPage1Value" value="<?php echo $recordsCTD[0]->volPage1Value; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="6">
                                                            <input readonly type="text" id="" name="" value="Analytes" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Typical retention times (RT) " class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="rTime1" name="rTime1" value="<?php echo $recordsCTD[0]->rTime1; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="rTime2" name="rTime2" value="<?php echo $recordsCTD[0]->rTime2; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="rTime3" name="rTime3" value="<?php echo $recordsCTD[0]->rTime3; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="rTime4" name="rTime4" value="<?php echo $recordsCTD[0]->rTime4; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Relative retention times (RTImp./RTAPI or Int. Std.)" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="relativeTime1" name="relativeTime1" value="<?php echo $recordsCTD[0]->relativeTime1; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="relativeTime2" name="relativeTime2" value="<?php echo $recordsCTD[0]->relativeTime2; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="relativeTime3" name="relativeTime3" value="<?php echo $recordsCTD[0]->relativeTime3; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="relativeTime4" name="relativeTime4" value="<?php echo $recordsCTD[0]->relativeTime4; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Relative response factor (RFImp./RFAPI)" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="respFactor1" name="respFactor1" value="<?php echo $recordsCTD[0]->respFactor1; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="respFactor2" name="respFactor2" value="<?php echo $recordsCTD[0]->respFactor2; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="respFactor3" name="respFactor3" value="<?php echo $recordsCTD[0]->respFactor3; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="respFactor4" name="respFactor4" value="<?php echo $recordsCTD[0]->respFactor4; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="6">
                                                            <input readonly type="text" id="" name="" value="Specificity" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Linearity / Range" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Number of concentrations:Range (expressed as mg/ml and as % “A”):Slope:Y-intercept:Correlation coefficient (r2)" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="lRValue1" name="lRValue1" value="<?php echo $recordsCTD[0]->lRValue1; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="lRValue2" name="lRValue2" value="<?php echo $recordsCTD[0]->lRValue2; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="lRValue3" name="lRValue3" value="<?php echo $recordsCTD[0]->lRValue3; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="lRValue4" name="lRValue4" value="<?php echo $recordsCTD[0]->lRValue4; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Accuracy" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Conc.(s) (expressed as mg/ml and as % “A”):Number of replicates:Percent recovery (avg/RSD)" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="accuracy1" name="accuracy1" value="<?php echo $recordsCTD[0]->accuracy1; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="accuracy2" name="accuracy2" value="<?php echo $recordsCTD[0]->accuracy2; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="accuracy3" name="accuracy3" value="<?php echo $recordsCTD[0]->accuracy3; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="accuracy4" name="accuracy4" value="<?php echo $recordsCTD[0]->accuracy4; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Precision /Repeatability:(intra-assay precision)" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Conc.(s) (expressed as mg/ml and as % “A”):Number of replicates:Result (avg/RSD)" class="form-control required">
                                                          </td>
                                                          <td colspan="4">
                                                            <input type="text" id="precision1" name="precision1" value="<?php echo $recordsCTD[0]->precision1; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Precision /Intermediate Precision:(days/analysts/equipment)" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Parameter(s) altered:Result (avg/RSD)" class="form-control required">
                                                          </td>
                                                          <td colspan="4">
                                                            <input type="text" id="precisionInter1" name="precisionInter1" value="<?php echo $recordsCTD[0]->precisionInter1; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Limit of Detection (LOD): (expressed as mg/ml and as % “A”)" class="form-control required">
                                                          </td>
                                                          <td colspan="4">
                                                            <input type="text" id="lod" name="lod" value="<?php echo $recordsCTD[0]->lod; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Limit of Quantitation (LOQ): (expressed as mg/ml and as % “A”)" class="form-control required">
                                                          </td>
                                                          <td colspan="4">
                                                            <input type="text" id="loq" name="loq" value="<?php echo $recordsCTD[0]->loq; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Robustness" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Stability of solutions:Other variables/effects" class="form-control required">
                                                          </td>
                                                          <td colspan="4">
                                                            <input type="text" id="robustness1" name="robustness1" value="<?php echo $recordsCTD[0]->robustness1; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Typical chromatograms or spectra may be found in" class="form-control required">
                                                          </td>
                                                          <td colspan="4">
                                                            <input type="text" id="chromatograms" name="chromatograms" value="<?php echo $recordsCTD[0]->chromatograms; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td colspan="2">
                                                            <input readonly type="text" id="" name="" value="Company(s) responsible for method validation" class="form-control required">
                                                          </td>
                                                          <td colspan="4">
                                                            <input type="text" id="responsible" name="responsible" value="<?php echo $recordsCTD[0]->responsible; ?>" class="form-control required">
                                                          </td>
                                                        </tr>
                                                        <?php $sn++ ?>
                                                      </tbody>
                                            ...
                                            <div class="col-xs-12">
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="descOfPharmaDrugProd" name="descOfPharmaDrugProd" class="form-control" rows="5" placeholder="<e.g The proposed XYZ 50-mg tablets are available as white, oval, film coated immediate release tablets, debossed with‘50’ on one side and a break line on the other side> "><?php echo $recordsCTD[0]->descOfPharmaDrugProd; ?></textarea>
                                                </div>
                                              </div>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailcompositionofdrugproduct" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        <?php $sn=1; ?>
                                                        <?php
                                                        if(empty($recordsDetailCompositionOfDrugProduct))
                                                        {
                                                        ?>
                                                        <tr>
                                                        ...
                                                        if(!empty($recordsDetailCompositionOfDrugProduct))
                                                        {
                                                            foreach($recordsDetailCompositionOfDrugProduct as $detail)
                                                            {
                                                        ?>
                                                        <tr>
                                                          <td><?=$sn?>.<input type="hidden" id="tabledetailcompositionofdrugproduct-id_<?=$sn?>" name="tabledetailcompositionofdrugproduct-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                                          <td>
                                                            <input type="text" id="tabledetailcompositionofdrugproduct-componentAndQty_<?=$sn?>" name="tabledetailcompositionofdrugproduct-componentAndQty_detail[]" value="<?php echo $detail->componentAndQty; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailcompositionofdrugproduct-function_<?=$sn?>" name="tabledetailcompositionofdrugproduct-function_detail[]" value="<?php echo $detail->function; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailcompositionofdrugproduct-perUnitQty_<?=$sn?>" name="tabledetailcompositionofdrugproduct-perUnitQty_detail[]" value="<?php echo $detail->perUnitQty; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailcompositionofdrugproduct-percentage_<?=$sn?>" name="tabledetailcompositionofdrugproduct-percentage_detail[]" value="<?php echo $detail->percentage; ?>" class="form-control required">
                                                          </td>
                                                          <td class="text-center widthMaxContent">
                                                            <div class="btn-group">
                                                              <i class="btn btn-primary fa fa-plus"></i>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="typeOfContainerSys" name="typeOfContainerSys" class="form-control" rows="5" placeholder="<The container-closure used for the drug product (and accompanying reconstitution diluent, if applicable) should be briefly described, with further details provided under 3.2.P.7 Container-closure system>"><?php echo $recordsCTD[0]->typeOfContainerSys; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="compatibilityOfDrugSubstance" name="compatibilityOfDrugSubstance" class="form-control" rows="5" placeholder="<If the qualitative composition of the formulation is not similar to innovator / reference product, the drug-excipient compatibility studies should be provided>"><?php echo $recordsCTD[0]->compatibilityOfDrugSubstance; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="keyCharacteristics" name="keyCharacteristics" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->keyCharacteristics; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="fixedDoseCombinations" name="fixedDoseCombinations" class="form-control" rows="5" placeholder="<For combination products, which are not approved by any reference regulatory authority, the compatibility of drug substances with each other should be discussed>"><?php echo $recordsCTD[0]->fixedDoseCombinations; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="choiceOfExcipients" name="choiceOfExcipients" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->choiceOfExcipients; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="summaryOfDevDrugProd" name="summaryOfDevDrugProd" class="form-control" rows="5" placeholder="<Brief discussion on the formulation development procedure adapted for the currently applied Drug Product>"><?php echo $recordsCTD[0]->summaryOfDevDrugProd; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="pharmaEquivalence" name="pharmaEquivalence" class="form-control" rows="5" placeholder="<The comparison of the developed formulation and the innovator / reference / comparator product including the results of all the quality tests should be submitted and discussed>"><?php echo $recordsCTD[0]->pharmaEquivalence; ?></textarea>
                                                </div>
                                              </div>
                            ...
                            "><?php echo $recordsCTD[0]->summaryOfDissolutionResults; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="justificationOfOverages" name="justificationOfOverages" class="form-control" rows="5" placeholder="<Generally overages are not acceptable unless fully justified>"><?php echo $recordsCTD[0]->justificationOfOverages; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="performanceParameters" name="performanceParameters" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->performanceParameters; ?></textarea>
                                                </div>
                                              </div>
                            ...
                            "><?php echo $recordsCTD[0]->devOfManufacturingProcess; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="suitabilityOfContainer" name="suitabilityOfContainer" class="form-control" rows="7" placeholder="<A brief description of container closure should be included>"><?php echo $recordsCTD[0]->suitabilityOfContainer; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="multiDoseContainer" name="multiDoseContainer" class="form-control" rows="7" placeholder="<e.g. for Dry Powder Inhalers supplied with rotacaps, the studies including uniformity of delivered dose, aerodynamic particle size distribution etc. should be provided>"><?php echo $recordsCTD[0]->multiDoseContainer; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="compatibilityOfDrugProduct" name="compatibilityOfDrugProduct" class="form-control" rows="7" placeholder="<Compatibility studies for the dry powder for injections and dry powder for suspension should be performed as per the instructions provided in individual label of the drug product>"><?php echo $recordsCTD[0]->compatibilityOfDrugProduct; ?></textarea>
                                                </div>
                                              </div>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailproductmanufacturer" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        <?php $sn=1; ?>
                                                        <?php
                                                        if(empty($recordsDetailProductManufacturer))
                                                        {
                                                        ?>
                                                        <tr>
                                                        ...
                                                        if(!empty($recordsDetailProductManufacturer))
                                                        {
                                                            foreach($recordsDetailProductManufacturer as $detail)
                                                            {
                                                        ?>
                                                        <tr>
                                                          <td><?=$sn?>.<input type="hidden" id="tabledetailproductmanufacturer-id_<?=$sn?>" name="tabledetailproductmanufacturer-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                                          <td>
                                                            <input type="text" id="tabledetailproductmanufacturer-mfgNameAddress_<?=$sn?>" name="tabledetailproductmanufacturer-mfgNameAddress_detail[]" value="<?php echo $detail->mfgNameAddress; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailproductmanufacturer-mfgResponsibility_<?=$sn?>" name="tabledetailproductmanufacturer-mfgResponsibility_detail[]" value="<?php echo $detail->mfgResponsibility; ?>" class="form-control required">
                                                          </td>
                                                          <td class="text-center widthMaxContent">
                                                            <div class="btn-group">
                                                              <i class="btn btn-primary fa fa-plus"></i>
                            ...
                            "><?php echo $recordsCTD[0]->gmpOfAllMfgSites; ?></textarea>
                                                </div>
                                              </div>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailbatchformula" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        <?php $sn=1; ?>
                                                        <?php
                                                        if(empty($recordsDetailBatchFormula))
                                                        {
                                                        ?>
                                                        <tr>
                                                        ...
                                                        if(!empty($recordsDetailBatchFormula))
                                                        {
                                                            foreach($recordsDetailBatchFormula as $detail)
                                                            {
                                                        ?>
                                                        <tr>
                                                          <td><?=$sn?>.<input type="hidden" id="tabledetailbatchformula-id_<?=$sn?>" name="tabledetailbatchformula-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                                          <td>
                                                            <input type="text" id="tabledetailbatchformula-componentQualityStd_<?=$sn?>" name="tabledetailbatchformula-componentQualityStd_detail[]" value="<?php echo $detail->componentQualityStd; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailbatchformula-quantityPerBatch_<?=$sn?>" name="tabledetailbatchformula-quantityPerBatch_detail[]" value="<?php echo $detail->quantityPerBatch; ?>" class="form-control required">
                                                          </td>
                                                          <td class="text-center widthMaxContent">
                                                            <div class="btn-group">
                                                              <i class="btn btn-primary fa fa-plus"></i>
                            ...
                            "><?php echo $recordsCTD[0]->flowDiagramOfMfgProcess; ?></textarea>
                                                </div>
                                              </div>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailcontrolsperformed" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        <?php $sn=1; ?>
                                                        <?php
                                                        if(empty($recordsDetailControlsPerformed))
                                                        {
                                                        ?>
                                                        <tr>
                                                        ...
                                                        if(!empty($recordsDetailControlsPerformed))
                                                        {
                                                            foreach($recordsDetailControlsPerformed as $detail)
                                                            {
                                                        ?>
                                                        <tr>
                                                          <td><?=$sn?>.<input type="hidden" id="tabledetailcontrolsperformed-id_<?=$sn?>" name="tabledetailcontrolsperformed-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                                          <td>
                                                            <input type="text" id="tabledetailcontrolsperformed-controlsStep_<?=$sn?>" name="tabledetailcontrolsperformed-controlsStep_detail[]" value="<?php echo $detail->controlsStep; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailcontrolsperformed-controlsTest_<?=$sn?>" name="tabledetailcontrolsperformed-controlsTest_detail[]" value="<?php echo $detail->controlsTest; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailcontrolsperformed-controlsAcceptance_<?=$sn?>" name="tabledetailcontrolsperformed-controlsAcceptance_detail[]" value="<?php echo $detail->controlsAcceptance; ?>" class="form-control required">
                                                          </td>
                                                          <td class="text-center widthMaxContent">
                                                            <div class="btn-group">
                                                              <i class="btn btn-primary fa fa-plus"></i>
                            ...
                            "><?php echo $recordsCTD[0]->proposedProcessValidation; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="controlOfExcipients" name="controlOfExcipients" class="form-control" rows="7" placeholder="<If the excipient(s) are in pharmacopoeia there is no need to provide detailed specifications or its analytical procedures. However for excipients of non-compendial standards, specifications as well as analytical procedures should be provided>"><?php echo $recordsCTD[0]->controlOfExcipients; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="inHouseStandardSpecs" name="inHouseStandardSpecs" class="form-control" rows="7" placeholder="The specifications for excipients of non-compendial standard should be provided>"><?php echo $recordsCTD[0]->inHouseStandardSpecs; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="inHouseStandardAnalyticalProc" name="inHouseStandardAnalyticalProc" class="form-control" rows="7" placeholder="<Copies of analytical procedures of non-compendial excipient should be submitted>"><?php echo $recordsCTD[0]->inHouseStandardAnalyticalProc; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="inHouseStandardValidationProc" name="inHouseStandardValidationProc" class="form-control" rows="7" placeholder=""><?php echo $recordsCTD[0]->inHouseStandardValidationProc; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="inHouseStandardJustificationProc" name="inHouseStandardJustificationProc" class="form-control" rows="7" placeholder=""><?php echo $recordsCTD[0]->inHouseStandardJustificationProc; ?></textarea>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="excipientsOfHumanOrigin" name="excipientsOfHumanOrigin" class="form-control" rows="7" placeholder="<For excipients of human or animal origin, a certificate should be provided, confirming that the excipient(s) are free from BSE and TSE>"><?php echo $recordsCTD[0]->excipientsOfHumanOrigin; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="novelExcipients" name="novelExcipients" class="form-control" rows="7" placeholder="<For excipient(s) used for the first time in a drug product or by a new route of administration, full details of specification and testing method should be provided>"><?php echo $recordsCTD[0]->novelExcipients; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-6">
                                                <div class="form-group">
                                                  ...
                                                  <input type="text" id="specsStandardDrugProduct" name="specsStandardDrugProduct" value="<?php echo $recordsCTD[0]->specsStandardDrugProduct; ?>" autocomplete="off" readonly onfocus="this.removeAttribute('readonly');" class="form-control required">
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-6">
                                                <div class="form-group">
                                                  ...
                                                  <input type="text" id="specsRefDrugProduct" name="specsRefDrugProduct" value="<?php echo $recordsCTD[0]->specsRefDrugProduct; ?>" autocomplete="off" readonly onfocus="this.removeAttribute('readonly');" class="form-control required">
                                                </div>
                                              </div>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailsample" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Description" class="form-control required">
                                                          </td>
                                                          
                                                          <td>
                                                            <input type="text" id="descReleaseAcceptanceCriteria" name="descReleaseAcceptanceCriteria" value="<?php echo $recordsCTD[0]->descReleaseAcceptanceCriteria; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="descShelfLifeAcceptanceCriteria" name="descShelfLifeAcceptanceCriteria" value="<?php echo $recordsCTD[0]->descShelfLifeAcceptanceCriteria; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="analyticalProcedure" name="analyticalProcedure" value="<?php echo $recordsCTD[0]->analyticalProcedure; ?>" class="form-control required">
                                                          </td>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Identification" class="form-control required">
                                                          </td>
                                                          
                                                          <td>
                                                            <input type="text" id="identReleaseAcceptanceCriteria" name="identReleaseAcceptanceCriteria" value="<?php echo $recordsCTD[0]->identReleaseAcceptanceCriteria; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="identShelfLifeAcceptanceCriteria" name="identShelfLifeAcceptanceCriteria" value="<?php echo $recordsCTD[0]->identShelfLifeAcceptanceCriteria; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="identAnalyticalProc" name="identAnalyticalProc" value="<?php echo $recordsCTD[0]->identAnalyticalProc; ?>" class="form-control required">
                                                          </td>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Impurities" class="form-control required">
                                                          </td>
                                                          
                                                          <td>
                                                            <input type="text" id="impuritiesReleaseAccpetanceCriteria" name="impuritiesReleaseAccpetanceCriteria" value="<?php echo $recordsCTD[0]->impuritiesReleaseAccpetanceCriteria; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="impuritiesShelfLifeAccpetanceCriteria" name="impuritiesShelfLifeAccpetanceCriteria" value="<?php echo $recordsCTD[0]->impuritiesShelfLifeAccpetanceCriteria; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="impuritiesAnalyticalProc" name="impuritiesAnalyticalProc" value="<?php echo $recordsCTD[0]->impuritiesAnalyticalProc; ?>" class="form-control required">
                                                          </td>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Assay" class="form-control required">
                                                          </td>
                                                          
                                                          <td>
                                                            <input type="text" id="assayReleaseAcceptanceCriteria" name="assayReleaseAcceptanceCriteria" value="<?php echo $recordsCTD[0]->assayReleaseAcceptanceCriteria; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="assayShelfLifeAcceptanceCriteria" name="assayShelfLifeAcceptanceCriteria" value="<?php echo $recordsCTD[0]->assayShelfLifeAcceptanceCriteria; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="assayAnalyticalProc" name="assayAnalyticalProc" value="<?php echo $recordsCTD[0]->assayAnalyticalProc; ?>" class="form-control required">
                                                          </td>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="etc." class="form-control required">
                                                          </td>
                                                          
                                                          <td>
                                                            <input type="text" id="etcReleaseAcceptanceCriteria" name="etcReleaseAcceptanceCriteria" value="<?php echo $recordsCTD[0]->etcReleaseAcceptanceCriteria; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="etcShelfLifeAcceptanceCriteria" name="etcShelfLifeAcceptanceCriteria" value="<?php echo $recordsCTD[0]->etcShelfLifeAcceptanceCriteria; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="etcAnalyticalProc" name="etcAnalyticalProc" value="<?php echo $recordsCTD[0]->etcAnalyticalProc; ?>" class="form-control required">
                                                          </td>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="analyticalProcSummary" name="analyticalProcSummary" class="form-control" rows="7" placeholder="<Provide brief tabulated summary of analytical procedures including key method parameters and conditions instead of attaching detailed analytical methods of Drug Product>"><?php echo $recordsCTD[0]->analyticalProcSummary; ?></textarea>
                                                </div>
                                              </div>
                            ...
                            "><?php echo $recordsCTD[0]->validationInfo; ?></textarea>
                                                </div>
                                              </div>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailbatchanalysis" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        <?php $sn=1; ?>
                                                        <?php
                                                        if(empty($recordsDetailBatchAnalysis))
                                                        {
                                                        ?>
                                                        <tr>
                                                        ...
                                                        if(!empty($recordsDetailBatchAnalysis))
                                                        {
                                                            foreach($recordsDetailBatchAnalysis as $detail)
                                                            {
                                                        ?>
                                                        <tr>
                                                          <td><?=$sn?>.<input type="hidden" id="tabledetailbatchanalysis-id_<?=$sn?>" name="tabledetailbatchanalysis-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                                          <td>
                                                            <input type="text" id="tabledetailbatchanalysis-batchNumber_<?=$sn?>" name="tabledetailbatchanalysis-batchNumber_detail[]" value="<?php echo $detail->batchNumber; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailbatchanalysis-batchSize_<?=$sn?>" name="tabledetailbatchanalysis-batchSize_detail[]" value="<?php echo $detail->batchSize; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="date" id="tabledetailbatchanalysis-mfgDate_<?=$sn?>" name="tabledetailbatchanalysis-mfgDate_detail[]" value="<?php echo $detail->mfgDate; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailbatchanalysis-useOf_<?=$sn?>" name="tabledetailbatchanalysis-useOf_detail[]" value="<?php echo $detail->useOf; ?>" class="form-control required">
                                                          </td>
                                                          <td class="text-center widthMaxContent">
                                                            <div class="btn-group">
                                                              <i class="btn btn-primary fa fa-plus"></i>
                                                    ...
                                                    <table id="tabledetailbatchanalysissummary" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>
                                                            <input type="text" id="descAcceptanceCriteria1" name="descAcceptanceCriteria1" value="<?php echo $recordsCTD[0]->descAcceptanceCriteria1; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="descBatchX1" name="descBatchX1" value="<?php echo $recordsCTD[0]->descBatchX1; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="descBatchY1" name="descBatchY1" value="<?php echo $recordsCTD[0]->descBatchY1; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="descEtc1" name="descEtc1" value="<?php echo $recordsCTD[0]->descEtc1; ?>" class="form-control required">
                                                          </td>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>
                                                            <input type="text" id="identAcceptanceCriteria1" name="identAcceptanceCriteria1" value="<?php echo $recordsCTD[0]->identAcceptanceCriteria1; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="identBatchX1" name="identBatchX1" value="<?php echo $recordsCTD[0]->identBatchX1; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="identBatchY1" name="identBatchY1" value="<?php echo $recordsCTD[0]->identBatchY1; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="identEtc1" name="identEtc1" value="<?php echo $recordsCTD[0]->identEtc1; ?>" class="form-control required">
                                                          </td>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>
                                                            <input type="text" id="impuritiesAcceptanceCriteria1" name="impuritiesAcceptanceCriteria1" value="<?php echo $recordsCTD[0]->impuritiesAcceptanceCriteria1; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="impuritiesBatchX1" name="impuritiesBatchX1" value="<?php echo $recordsCTD[0]->impuritiesBatchX1; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="impuritiesBatchY1" name="impuritiesBatchY1" value="<?php echo $recordsCTD[0]->impuritiesBatchY1; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="impuritiesEtc1" name="impuritiesEtc1" value="<?php echo $recordsCTD[0]->impuritiesEtc1; ?>" class="form-control required">
                                                          </td>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>
                                                            <input type="text" id="assayAcceptanceCriteria1" name="assayAcceptanceCriteria1" value="<?php echo $recordsCTD[0]->assayAcceptanceCriteria1; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="assayBatchX1" name="assayBatchX1" value="<?php echo $recordsCTD[0]->assayBatchX1; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="assayBatchY1" name="assayBatchY1" value="<?php echo $recordsCTD[0]->assayBatchY1; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="assayEtc1" name="assayEtc1" value="<?php echo $recordsCTD[0]->assayEtc1; ?>" class="form-control required">
                                                          </td>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>
                                                            <input type="text" id="etcAcceptanceCriteria1" name="etcAcceptanceCriteria1" value="<?php echo $recordsCTD[0]->etcAcceptanceCriteria1; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="etcBatchX1" name="etcBatchX1" value="<?php echo $recordsCTD[0]->etcBatchX1; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="etcBatchY1" name="etcBatchY1" value="<?php echo $recordsCTD[0]->etcBatchY1; ?>" class="form-control required">
                                                          </td>

                                                          <td>
                                                            <input type="text" id="etcEtc1" name="etcEtc1" value="<?php echo $recordsCTD[0]->etcEtc1; ?>" class="form-control required">
                                                          </td>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label> (a) Summary of the validation information (e.g. validation parameters and results)</label>
                                                  <textarea id="characterizationOfImpurities" name="characterizationOfImpurities" class="form-control" rows="7" placeholder="Those impurities that are degradation product should be included in the specifications>"><?php echo $recordsCTD[0]->characterizationOfImpurities; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="justificationOfSpecs1" name="justificationOfSpecs1" class="form-control" rows="7" placeholder="<The justification of specification(s) for non-pharmacopeial products must be provided. Justification of specification of non-pharmacopeial product should be based on batch analysis results>"><?php echo $recordsCTD[0]->justificationOfSpecs1; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="referenceStandards" name="referenceStandards" class="form-control" rows="7" placeholder="<For testing of Pharmacopeial Drug Product(s), the use of primary reference standard is recommended, however for non-pharmacopeial Drug Product(s), a secondary reference standard is acceptable>"><?php echo $recordsCTD[0]->referenceStandards; ?></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="containerClosureSystem" name="containerClosureSystem" class="form-control" rows="7" placeholder=""><?php echo $recordsCTD[0]->containerClosureSystem; ?></textarea>
                                                </div>
                                              </div>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailcontainerclosuresystem" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        <?php $sn=1; ?>
                                                        <?php
                                                        if(empty($recordsDetailContainerClosureSystem))
                                                        {
                                                        ?>
                                                        <tr>
                                                        ...
                                                        if(!empty($recordsDetailContainerClosureSystem))
                                                        {
                                                            foreach($recordsDetailContainerClosureSystem as $detail)
                                                            {
                                                        ?>
                                                        <tr>
                                                          <td><?=$sn?>.<input type="hidden" id="tabledetailcontainerclosuresystem-id_<?=$sn?>" name="tabledetailcontainerclosuresystem-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                                          <td>
                                                            <input type="text" id="tabledetailcontainerclosuresystem-containerSizeDesc_<?=$sn?>" name="tabledetailcontainerclosuresystem-containerSizeDesc_detail[]" value="<?php echo $detail->containerSizeDesc; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailcontainerclosuresystem-containerSizeUnit_<?=$sn?>" name="tabledetailcontainerclosuresystem-containerSizeUnit_detail[]" value="<?php echo $detail->containerSizeUnit; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailcontainerclosuresystem-containerSizeValue_<?=$sn?>" name="tabledetailcontainerclosuresystem-containerSizeValue_detail[]" value="<?php echo $detail->containerSizeValue; ?>" class="form-control required">
                                                          </td>
                                                          <td class="text-center widthMaxContent">
                                                            <div class="btn-group">
                                                              <i class="btn btn-primary fa fa-plus"></i>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailproductstability" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        <?php $sn=1; ?>
                                                        <?php
                                                        if(empty($recordsDetailProductStability))
                                                        {
                                                        ?>
                                                        <tr>
                                                        ...
                                                        if(!empty($recordsDetailProductStability))
                                                        {
                                                            foreach($recordsDetailProductStability as $detail)
                                                            {
                                                        ?>
                                                        <tr>
                                                          <td><?=$sn?>.<input type="hidden" id="tabledetailproductstability-id_<?=$sn?>" name="tabledetailproductstability-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                                          <td>
                                                            <input type="text" id="tabledetailproductstability-storageCondition1_<?=$sn?>" name="tabledetailproductstability-storageCondition1_detail[]" value="<?php echo $detail->storageCondition1; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailproductstability-batchNo_<?=$sn?>" name="tabledetailproductstability-batchNo_detail[]" value="<?php echo $detail->batchNo; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailproductstability-batchSize_<?=$sn?>" name="tabledetailproductstability-batchSize_detail[]" value="<?php echo $detail->batchSize; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailproductstability-containerClosure_<?=$sn?>" name="tabledetailproductstability-containerClosure_detail[]" value="<?php echo $detail->containerClosure; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailproductstability-completedTestingInterval_<?=$sn?>" name="tabledetailproductstability-completedTestingInterval_detail[]" value="<?php echo $detail->completedTestingInterval; ?>" class="form-control required">
                                                          </td>
                                                          <td class="text-center widthMaxContent">
                                                            <div class="btn-group">
                                                              <i class="btn btn-primary fa fa-plus"></i>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailproductstability2" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        <?php $sn=1; ?>
                                                        <?php
                                                        if(empty($recordsDetailProductStability2))
                                                        {
                                                        ?>
                                                        <tr>
                                                        ...
                                                        if(!empty($recordsDetailProductStability2))
                                                        {
                                                            foreach($recordsDetailProductStability2 as $detail)
                                                            {
                                                        ?>
                                                        <tr>
                                                          <td><?=$sn?>.<input type="hidden" id="tabledetailproductstability2-id_<?=$sn?>" name="tabledetailproductstability2-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                                          <td>
                                                            <input type="text" id="tabledetailproductstability2-storageCondition2_<?=$sn?>" name="tabledetailproductstability2-storageCondition2_detail[]" value="<?php echo $detail->storageCondition2; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailproductstability2-batchNo2_<?=$sn?>" name="tabledetailproductstability2-batchNo2_detail[]" value="<?php echo $detail->batchNo2; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailproductstability2-batchSize2_<?=$sn?>" name="tabledetailproductstability2-batchSize2_detail[]" value="<?php echo $detail->batchSize2; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailproductstability2-containerClosure2_<?=$sn?>" name="tabledetailproductstability2-containerClosure2_detail[]" value="<?php echo $detail->containerClosure2; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailproductstability2-completedTestingInterval2_<?=$sn?>" name="tabledetailproductstability2-completedTestingInterval2_detail[]" value="<?php echo $detail->completedTestingInterval2; ?>" class="form-control required">
                                                          </td>
                                                          <td class="text-center widthMaxContent">
                                                            <div class="btn-group">
                                                              <i class="btn btn-primary fa fa-plus"></i>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="additionalStabilityStudy" name="additionalStabilityStudy" class="form-control" rows="7" placeholder="<e.g. in-use studies for drug products which are to be reconstituted before use>"><?php echo $recordsCTD[0]->additionalStabilityStudy; ?></textarea>
                                                </div>
                                              </div>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailstoragestatement" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        <?php $sn=1; ?>
                                                        <?php
                                                        if(empty($recordsDetailStorageStatement))
                                                        {
                                                        ?>
                                                        <tr>
                                                        ...
                                                        if(!empty($recordsDetailStorageStatement))
                                                        {
                                                            foreach($recordsDetailStorageStatement as $detail)
                                                            {
                                                        ?>
                                                        <tr>
                                                          <td><?=$sn?>.<input type="hidden" id="tabledetailstoragestatement-id_<?=$sn?>" name="tabledetailstoragestatement-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                                          <td>
                                                            <input type="text" id="tabledetailstoragestatement-containerClosure_<?=$sn?>" name="tabledetailstoragestatement-containerClosure_detail[]" value="<?php echo $detail->containerClosure; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailstoragestatement-storageStatement_<?=$sn?>" name="tabledetailstoragestatement-storageStatement_detail[]" value="<?php echo $detail->storageStatement; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailstoragestatement-shelfLife_<?=$sn?>" name="tabledetailstoragestatement-shelfLife_detail[]" value="<?php echo $detail->shelfLife; ?>" class="form-control required">
                                                          </td>
                                                          <td class="text-center widthMaxContent">
                                                            <div class="btn-group">
                                                              <i class="btn btn-primary fa fa-plus"></i>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailproposedstoragestatement" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        <?php $sn=1; ?>
                                                        <?php
                                                        if(empty($recordsDetailProposedStorageStatement))
                                                        {
                                                        ?>
                                                        <tr>
                                                        ...
                                                        if(!empty($recordsDetailProposedStorageStatement))
                                                        {
                                                            foreach($recordsDetailProposedStorageStatement as $detail)
                                                            {
                                                        ?>
                                                        <tr>
                                                          <td><?=$sn?>.<input type="hidden" id="tabledetailproposedstoragestatement-id_<?=$sn?>" name="tabledetailproposedstoragestatement-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                                          <td>
                                                            <input type="text" id="tabledetailproposedstoragestatement-storageStatement2_<?=$sn?>" name="tabledetailproposedstoragestatement-storageStatement2_detail[]" value="<?php echo $detail->storageStatement2; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailproposedstoragestatement-shelfLife2_<?=$sn?>" name="tabledetailproposedstoragestatement-shelfLife2_detail[]" value="<?php echo $detail->shelfLife2; ?>" class="form-control required">
                                                          </td>
                                                          <td class="text-center widthMaxContent">
                                                            <div class="btn-group">
                                                              <i class="btn btn-primary fa fa-plus"></i>
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailpostapprovalstability" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Storage condition(s) (◦C, % RH)" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input type="text" id="storageCondition2" name="storageCondition2" value="<?php echo $recordsCTD[0]->storageCondition2; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Batch Number(s) /Batch Size(s)" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input type="text" id="batchNumberSize" name="batchNumberSize" value="<?php echo $recordsCTD[0]->batchNumberSize; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Test and Accpetance Criteria" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Description" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="testDescCriteriaValue" name="testDescCriteriaValue" value="<?php echo $recordsCTD[0]->testDescCriteriaValue; ?>" class="form-control required">
                                                          </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Moisture" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="testDescCriteriaValue1" name="testDescCriteriaValue1" value="<?php echo $recordsCTD[0]->testDescCriteriaValue1; ?>" class="form-control required">
                                                          </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>
                                                            <input type="text" id="testDescCriteriaValue2" name="testDescCriteriaValue2" value="<?php echo $recordsCTD[0]->testDescCriteriaValue2; ?>" class="form-control required">
                                                          </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>
                                                            <input type="text" id="testDescCriteriaValue3" name="testDescCriteriaValue3" value="<?php echo $recordsCTD[0]->testDescCriteriaValue3; ?>" class="form-control required">
                                                          </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>
                                                            <input type="text" id="testDescCriteriaValue4" name="testDescCriteriaValue4" value="<?php echo $recordsCTD[0]->testDescCriteriaValue4; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Testing Frequency" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input type="text" id="testingFrequency1" name="testingFrequency1" value="<?php echo $recordsCTD[0]->testingFrequency1; ?>" class="form-control required">
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <input readonly type="text" id="" name="" value="Container Closure System" class="form-control required">
                                                          </td>
                                                          <td colspan="2">
                                                            <input type="text" id="containerClosureSystem3" name="containerClosureSystem3" value="<?php echo $recordsCTD[0]->containerClosureSystem3; ?>" class="form-control required">
                                                          </td>
                                                        </tr>
                                                        <?php $sn++ ?>
                                                      </tbody>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="conclusionStabilityStudy" name="conclusionStabilityStudy" class="form-control" rows="7" placeholder=""><?php echo $recordsCTD[0]->conclusionStabilityStudy; ?></textarea>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="box-body" style="display:none;" id="div_53">
                                            <div class="col-xs-12">
                                                <h4>Please refer to the tab <u>Product Info</u>.</h4>
                                            </div>
                                          </div>
                                            ...
                                            <div class="col-xs-12">
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="qaqc" name="qaqc" class="form-control" rows="5" placeholder="Name of the Active Pharmaceutical Ingredient(s) / Drug Substance(s)"><?php echo $recordsCTD[0]->qaqc; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>3.0 PHARMACEUTICAL FORM:-</label>
                                                  <textarea id="pharmaceuticalForm" name="pharmaceuticalForm" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->pharmaceuticalForm; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>4.0 CLINICAL PARTICULARS:-</label>
                                                  <textarea id="clinicalParticulars" name="clinicalParticulars" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->clinicalParticulars; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>4.1 Therapeutic indications</label>
                                                  <textarea id="therapeuticIndication" name="therapeuticIndication" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->therapeuticIndication; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>4.2 Posology and method of administration</label>
                                                  <textarea id="posologyandmethodofadministration" name="posologyandmethodofadministration" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->posologyandmethodofadministration; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>4.3 Contraindications</label>
                                                  <textarea id="contraindications" name="contraindications" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->contraindications; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>4.4 Special warnings and precautions for use</label>
                                                  <textarea id="warningandprecautionsforuse" name="warningandprecautionsforuse" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->warningandprecautionsforuse; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>4.5 Interaction with other medicinal products and other forms of interaction</label>
                                                  <textarea id="interactionwithothermedicinalproducts" name="interactionwithothermedicinalproducts" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->interactionwithothermedicinalproducts; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>4.6Fertility, pregnancy and lactation</label>
                                                  <textarea id="fertility" name="fertility" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->fertility; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>4.7 Effects on ability to drive and use machines</label>
                                                  <textarea id="effectsonabilitytodriveandusemachines" name="effectsonabilitytodriveandusemachines" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->effectsonabilitytodriveandusemachines; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>4.8 Undesirable effects</label>
                                                  <textarea id="undesirableEffects" name="undesirableEffects" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->undesirableEffects; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>4.9 Overdose</label>
                                                  <textarea id="overdose" name="overdose" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->overdose; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>5.0 PHARMACOLOGICAL PROPERTIES</label>
                                                  <textarea id="pharmalogicalProperties" name="pharmalogicalProperties" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->pharmalogicalProperties; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>5.1 Pharmacodynamics properties</label>
                                                  <textarea id="pharmadynamicsProperties" name="pharmadynamicsProperties" class="form-control" rows="5" placeholder="Therapeutic Classification & ATC Codes"><?php echo $recordsCTD[0]->pharmadynamicsProperties; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>5.2 Pharmacokinetic properties</label>
                                                  <textarea id="pharmacokinetivProperties" name="pharmacokinetivProperties" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->pharmacokinetivProperties; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>5.3 Preclinical safety data</label>
                                                  <textarea id="preclinicalSafetyData" name="preclinicalSafetyData" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->preclinicalSafetyData; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="box">
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailexcipients" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        <?php $sn=1; ?>
                                                        <?php
                                                        if(empty($recordsDetailExcipients))
                                                        {
                                                        ?>
                                                        <tr>
                                                        ...
                                                        if(!empty($recordsDetailExcipients))
                                                        {
                                                            foreach($recordsDetailExcipients as $detail)
                                                            {
                                                        ?>
                                                        <tr>
                                                          <td><?=$sn?>.<input type="hidden" id="tabledetailexcipients-id_<?=$sn?>" name="tabledetailexcipients-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                                          <td>
                                                            <input type="text" id="tabledetailexcipients-excipientName_<?=$sn?>" name="tabledetailexcipients-excipientName_detail[]" value="<?php echo $detail->excipientName; ?>" class="form-control required">
                                                          </td>
                                                          <td class="text-center widthMaxContent">
                                                            <div class="btn-group">
                                                              <i class="btn btn-primary fa fa-plus"></i>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea id="incompatibilities" name="incompatibilities" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->incompatibilities; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>6.4 Special precautions for storage</label>
                                                  <textarea id="specialPrecautionsForStorage" name="specialPrecautionsForStorage" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->specialPrecautionsForStorage; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>6.5 Nature and contents of container and special equipment for use/administration or Implantation</label>
                                                  <textarea id="natureandcontentsofcontainer" name="natureandcontentsofcontainer" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->natureandcontentsofcontainer; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label>6.6 Special precautions for disposal</label>
                                                  <textarea id="specialprecautionfordisposal" name="specialprecautionfordisposal" class="form-control" rows="5" placeholder=""><?php echo $recordsCTD[0]->specialprecautionfordisposal; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-xs-12">
                                                <div class="box">
                                                  ...
                                                  <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                                    ...
                                                    <table id="tabledetailspecificidentification" class="table table-bordered table-striped" width="100%">
                                                      ...
                                                      <tbody>
                                                        <?php $sn=1; ?>
                                                        <?php
                                                        if(empty($recordsDetailSpecificIdentification))
                                                        {
                                                        ?>
                                                        <tr>
                                                        ...
                                                        if(!empty($recordsDetailSpecificIdentification))
                                                        {
                                                            foreach($recordsDetailSpecificIdentification as $detail)
                                                            {
                                                        ?>
                                                        <tr>
                                                          <td><?=$sn?>.<input type="hidden" id="tabledetailspecificidentification-id_<?=$sn?>" name="tabledetailspecificidentification-id_detail[]" value="<?php echo $detail->id; ?>"></td>
                                                          <td>
                                                            <input type="text" id="tabledetailspecificidentification-testName_<?=$sn?>" name="tabledetailspecificidentification-testName_detail[]" value="<?php echo $detail->testName; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailspecificidentification-criteria_<?=$sn?>" name="tabledetailspecificidentification-criteria_detail[]" value="<?php echo $detail->criteria; ?>" class="form-control required">
                                                          </td>
                                                          <td>
                                                            <input type="text" id="tabledetailspecificidentification-reference_<?=$sn?>" name="tabledetailspecificidentification-reference_detail[]" value="<?php echo $detail->reference; ?>" class="form-control required">
                                                          </td>
                                                          <td class="text-center widthMaxContent">
                                                            <div class="btn-group">
                                                              <i class="btn btn-primary fa fa-plus"></i>
                              ...
                              <div class="tab-pane" id="tab_4" style="background-color: #f7f7f7 !important;">
                                ...
                                <div class="col-xs-12">
                                  ...
                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      <label>Fee Challan <i>[<font style="color: #F44336;">File Format</font><font style="color: #3f51b5;"> (*.JPEG, *.PNG, *.PDF)</font><font style="color: #F44336;"> Max. File Size</font><font style="color: #3f51b5;"> 5 MB</font>]</i></label>
                                      <input type="hidden" id="feeChallanPathHidden" name="feeChallanPath" value="<?php echo $records[0]->feeChallanPath; ?>">
                                  ...
                                  <div class="col-xs-6">
                                    <div class="form-group">
                                      <label>Fee Challan Link</label>
                                      <br>
                                      <a <?php if(!$records[0]->feeChallanPath){ echo 'disabled';} ?> <?php if($records[0]->feeChallanPath){ echo 'href="'.base_url().'uploads/company/'.$this->companyUniqueNo.'/Registration/'.$records[0]->feeChallanPath.'"';} ?> target="_blank" class="btn btn-success"><i class="fa fa-file-o"></i></a>
                                    </div>
                                  </div>
                                        ...
                                        <table id="tabledetailfeeinfo" class="table table-bordered table-striped" width="100%">
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                <input <?php if($records[0]->invoicePaid == 1){echo 'readonly';} ?> type="text" id="invoice" name="invoice" value="<?php echo $records[0]->invoice; ?>" class="form-control required">
                                              </td>
                                              <td>
                                                <b><?php echo $records[0]->invoiceDepositDate; ?></b>
                                              </td>
                                              <td>
                                                <b>
                                                <?php 
                                                // $get = file_get_contents('https://fee.dra.gov.pk/api/dris/'.$records[0]->invoice, false, stream_context_create(['http' => ['ignore_errors' => true]]));
                                                // $get = json_decode($get);
                                                // if($http_response_header[0] == 'HTTP/1.1 200 OK'){
                                                //     if($get->status == 1){
                                                //       if($records[0]->invoicePaid == 1){
                                                //         echo $get->amount;
                                                //       }
                                                //     }
                                                // }
                                              ...
                                              <td>
                                                <b id="invoicePaid"><?php if($records[0]->invoicePaid == 0){echo 'Pending';}else{echo 'Paid';} ?></b>
                                              </td>
                                            </tr>
                                            <?php $sn++ ?>
                                          </tbody>
                              ...
                              <div class="tab-pane" id="tab_5">
                                ...
                                <div class="col-xs-12">
                                  <div class="box">
                                    ...
                                    <div class="box-body table-responsive" style="background-color: #f1f1f1;">
                                      <!-- box-body -->
                                      <table id="tabledetailquery" class="table table-bordered table-striped" width="100%">
                                        <thead>
                                        <tr style="background-color: #ffffff;">
                                          <th>S.#</th>
                                          <th>Date & Time</th>
                                        ...
                                        <tbody>
                                          ...
                                          {
                                              foreach($recordsDetailQuery as $detail)
                                              {
                                          ?>
                                          <tr>
                                            <td><?=$sn?>.</td>
                                            ...
                                            <td>
                                              <div class="col-xs-6">
                                                <a <?php if(!$detail->filePath){ echo 'disabled';} ?> <?php if($detail->filePath){ echo 'href="'.base_url().'uploads/company/'.$this->companyUniqueNo.'/Registration/'.$detail->filePath.'"';} ?> target="_blank" class="btn btn-success"><i class="fa fa-file-o"></i></a>
                                              </div>
                                            </td>
                                          </tr>
                                          <?php $sn++ ?>
                    ...
                    <div class="form-group">
                      <label>Priority Reason</label>
                        <select class="form-control select2" id="priorityReasonId" name="priorityReasonId">
                          <option value="0">Selec Priority Reason</option>
                          <?php
                            if(!empty($priorityReason))
                            {
                              ...
                              {
                                  ?>
                                  <option value="<?php echo $record->id ?>" <?php if($record->id == $records[0]->priorityReasonId){ echo 'selected'; } ?>><?php echo $record->priorityReason ?></option>
                                  <?php
                              }
                            }
                          ?>
                  ...
                  <div class="col-xs-12">
                    <div class="form-group">
                      <label>Applicant's Remarks</label>
                      <textarea id="remarks" name="remarks" class="form-control" rows="3"><?php echo $records[0]->remarks; ?></textarea>
                    </div>
                  </div>

                  <div class="col-xs-12">
                    <div class="form-group">
                      <label>Final Remarks By DRAP</label>
                      <textarea disabled id="finalRemarksShowToCompany" name="" class="form-control" rows="3"><?php echo $records[0]->finalRemarksShowToCompany; ?></textarea>
                    </div>
                  </div>
  ...
  <script>
    $(document).ready(function(){
        // Setup - add a text input to each header cell
        $('#tabledetailproductstability thead tr').clone(true).appendTo( '#tabledetailproductstability thead' );
  ...
  <script>
    $(document).ready(function(){
        // Setup - add a text input to each header cell
        $('#tabledetailquery thead tr').clone(true).appendTo( '#tabledetailquery thead' );
        $('#tabledetailquery thead tr:eq(1) th').each( function (i) {
            var title = $(this).text();
            if(title == '' || title == 'S.#' || title == 'Action'){
              $(this).html( '' );
            }
        ...
        var table = $('#tabledetailquery').DataTable({
            'orderCellsTop': true,
            'fixedHeader'  : true,
            'paging'       : true,
            'lengthChange' : true,
    ...
    $( "#tabledetailquery thead th" ).click(function() {
      $( "#tabledetailquery thead th input" ).removeClass('hidden');
    });
  </script>
  <?php 
    $nodes = 0;
