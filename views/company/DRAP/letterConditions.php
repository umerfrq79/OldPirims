          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              ...
              <div class="card-tools">
                <?php
                  echo '<a href="'.base_url().$pageTitle[0]->url.'/add'.'" class="btn btn-primary"><i class="fa fa-plus"></i> New Letter Condition</a>';
                ?>
              </div>
            </div>
            <!-- /.card-header -->
              ...
              <table id="table" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr <?php //if(!(in_array($this->session->userdata('userId'), $seenBy))){echo "style='background-color: #92a1ad2e !important; font-weight:bold;'";} ?>>
                    ...
                    <td><?php echo $record->letterType; ?></td>
                    <td><?php echo $record->conditions; ?></td>
        ...
        <div class="card card-primary card-outline1">
          ...
          <div class="card-body cardBodyTransaction">
            <div class="row">
                ...
                if($myAction == 'edit'){
                    ?>
                    <input type="hidden"  name="id" value="<?php echo @$recordsEdit[0]->id; ?>" autocomplete="off" readonly  class="form-control">
                    <?php
                }
                ?>
                <div class="col-md-6">
                    <div class="form-group">
                      <?php $label = 'Letter Type'; ?>
                ...
                <div class="col-md-12">
                    <?php $label = 'Conditions'; ?>
                    <?php $column = 'conditions'; ?>
