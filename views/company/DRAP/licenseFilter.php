            ...
            <div class="col-12">
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        <div class="pull-left">
                            <h6 class="card-title txt-dark">License Search - DRAP</h6>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="<?php echo base_url(); ?>licenseFilter/lookup" method="post" >
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleFormControlSelect1">Search By</label>
                                                <select autofocus class="form-control" name="searchby" id="searchby">
                                                    <option value="1" selected >Qualified Staff CNIC </option>
                                                    <option value="2" <?php echo isset($searchby) && $searchby == 2?'selected':''; ?> >Section</option>
                                                    <option value="3" <?php echo isset($searchby) && $searchby == 3?'selected':''; ?> >Management CNIC</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-5 sectionfilter">
                                            <div class="form-group">
                                                <?php $label = 'Section Name'; ?>
                                                ...
                                                <select style="height: inherit" autofocus class="form-control select2" id="<?php echo @$column; ?>" name="<?php echo @$column; ?>">
                                                    ...
                                                    if(!empty($sections))
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <option value="<?php echo $section->id ?>" <?php echo isset($sectionId) && $sectionId == $section->id?'selected':''; ?> ><?php echo $section->section; ?></option>
                                                            <?php
                                                        }
                                                    }
                                                    ?>
                                        ...
                                        <div class="col-md-4 sectionfilter">
                                            <div class="form-group">
                                                ...
                                                <select style="height: inherit" autofocus class="form-control select2" id="<?php echo @$column; ?>" name="<?php echo @$column; ?>">
                                                    ...
                                                    if(!empty($pharmaGroup))
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <option value="<?php echo $detail->id ?>" <?php echo isset($pharmaGroupId) && $pharmaGroupId == $detail->id?'selected':''; ?> ><?php echo $detail->pharmaGroup; ?></option>
                                                            <?php
                                                        }
                                                    }
                                                    ?>
                    ...
                    <td class="text-center widthMaxContent">
                      <div class="btn-group">
                          ...
                          <?php if($this->roleId <> '26'){ ?>
                              <a target="_blank" href="<?php echo base_url().'licensereport/edit/'.$record->id; ?>" class="btn btn-warning"><i class="fa fa-file"></i></a>
                          <?php } ?>
