              ...
              <table id="table" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr <?php if(!(in_array($this->session->userdata('userId'), $seenBy))){echo "style='background-color: #92a1ad2e !important; font-weight:bold;'";} ?>>
                    ...
                    <td class="text-center"><?php if($record->licenseStatus == 'Submitted'){if($record->queuePosition <> 0){echo $record->queuePosition;}else{echo 'Now Serving';}}else{echo '';} ?></td>
                    <?php if($this->roleId == 26){?>
                      ...
                      <div class="btn-group">
                        ...
                        <div class="btn-group-prepend">
                          ...
                          <ul class="dropdown-menu" style="">
                            ...
                            <li class="dropdown-item"><a href="'.base_url().'report/view/License Note Sheet/'.$record->id.'">License Note Sheet</a></li>
                            ';} ?>
                            <!-- <?php if($record->phase == 'Site Verification'){ echo '
                            <li class="dropdown-item"><a href="'.base_url().'report/view/Site Verification Shortcoming Letter/'.$record->id.'">Site Verification Shortcoming Letter</a></li>
                            ';} ?> -->
                            <?php if($record->reviewer1Remarks){ echo '
                            <li class="dropdown-item"><a href="'.base_url().'report/view/Site Verification Shortcoming Letter/'.$record->id.'">Site Verification Shortcoming Letter</a></li>
                            ';} ?>
                            <?php if($record->phase == 'Site Verification' && $record->licenseStatus == 'Under Inspection'){ echo '
                            <li class="dropdown-item"><a href="'.base_url().'report/view/Site Verification Letter/'.$record->id.'">Site Verification Letter</a></li>
                            ';} ?>
                            <?php if($record->phase == 'Layout Plan' || $record->phase == 'Grant of License'){ echo '
                            <li class="dropdown-item"><a href="'.base_url().'report/view/Site Approval Letter/'.$record->id.'">Site Approval Letter</a></li>
                            ';} ?>
                            <?php if($record->reviewer1Remarks2){ echo '
                            <li class="dropdown-item"><a href="'.base_url().'report/view/Layout Plan Shortcoming Letter/'.$record->id.'">Layout Plan Shortcoming Letter</a></li>
                            ';} ?>
                            <?php if($record->phase == 'Grant of License'){ echo '
                            <li class="dropdown-item"><a href="'.base_url().'report/view/Layout Plan Approval Letter/'.$record->id.'">Layout Plan Approval Letter</a></li>
                            ';} ?>
                            <?php if($record->reviewer1Remarks3){ echo '
                            <li class="dropdown-item"><a href="'.base_url().'report/view/Applicant License Shortcoming Certificate/'.$record->id.'">Establishment License Shortcoming</a></li>
                            ';} ?>
                            <?php if($record->phase == 'Grant of License' && $record->panelOfInspector1){ echo '
                            <li class="dropdown-item"><a href="'.base_url().'report/view/Grant of License Panel of Inspector/'.$record->id.'">Grant of License Panel of Inspector</a></li>
                            ';} ?>
                            <?php if($record->licenseStatus == 'Approved'){ echo '
                            <li class="dropdown-item"><a href="'.base_url().'report/view/Applicant License Certificate/'.$record->id.'">Establishment License Certificate</a></li>
                            ';} ?>
                          </ul>
                        </div>
                ...
                <div class="card card-secondary border-secondary card-tabs" style="border: 3px solid;">
                  <div class="card-header p-0 pt-1">
                    <ul class="nav nav-tabs">
                      ...
                      <?php } ?>
                      <?php if(@$records[0]->phase == 'Grant of License' && @$records[0]->licenseStatus == 'Under Board Stage 2'){ ?>
                      <li class="nav-item">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane fade" id="tab5">
                        ...
                        <div class="row" style="float: left; width: 100%;">
                          ...
                          <?php if(@$recordsEdit[0]->phase == 'Grant of License' && @$recordsEdit[0]->phase == 'Recommended By Board Stage 3'){ ?>
                          <div class="col-md-6">
                            <div class="form-group">
