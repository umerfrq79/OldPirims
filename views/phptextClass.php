...
{	
	...
	{
		/* settings */
		$font = 'assets/dist/vendors/phptextcaptcha/phpcaptcha/font/monofont.ttf';/*define font*/
	...
	{	
		/* Settings */
		$text=$this->random();
		$font = 'assets/dist/vendors/phptextcaptcha/phpcaptcha/font/monofont.ttf';/* font */
		$textColor=$this->hexToRGB($textColor);	
