...
<head>
  ...
  <link id="favicon" rel="icon" href="<?php echo base_url(); ?>uploads/company/<?php echo $this->companyName; ?>/logo/logo.png"/>
            ...
            <div class="container-fluid">
              <div class="row mb-2">
                <div class="col-sm-6">
                  <h1>
                    Access Denied
                    <small>You are not allowed to use this application</small>
                  </h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <img src="<?php echo base_url() ?>assets/dist/img/error/access.png" alt="Access Denied Image" />
                </div>
