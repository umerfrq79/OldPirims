      ...
      <div class="container-fluid">
          ...
          <div class="row justify-content-center">
              ...
              <div class="card-header">
                  <div class="pull-left">
                      <h6 class="card-title txt-dark">Registered Drug Detail - DRAP</h6>
                  </div>
                      ...
                      <div class="row">
                          <div class="col-md-12">
                              <table class="table table-bordered">
                                  ...
                                  <tr>
                                      <td>Product Name</td>
                                      <td><?php echo isset($drug[0])?$drug[0]->approvedName:''; ?></td>
                                  </tr>
                                  <tr>
                                      <td>Registration No.</td>
                                      <td><?php echo isset($drug[0])?$drug[0]->registrationNo:''; ?></td>
                                  </tr>
                                  <tr>
                                      <td>Registrant</td>
                                      <td>
                                          <?php
                                          $company = $CI->loginModel->getCompany($drug[0]->companyAccountId);
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <?php
                                          $dosage = $CI->loginModel->getDosage($drug[0]->dosageFormId);
                                  ...
                                  <tr>
                                      <td>Used For</td>
                                      <td>
                                          <?php echo isset($drug[0])?(($drug[0]->usedForId == 1)?'Human': (($drug[0]->usedForId == 3)?'Veterinary':'')):''; ?>
                                      </td>
                                  </tr>
                                  <tr>
                                      <td>Registration Type</td>
                                      <td><?php echo isset($drug[0])?$drug[0]->regType:''; ?></td>
                                  </tr>
                              ...
                              <table class="table table-bordered">
                                  ...
                                  <?php
                                      ...
                                      foreach ($manufacturers as $manufacturer){
                                          ...
                                          <tr>
                                              <td><?php echo $m_sn++; ?></td>
                                              <td><?php echo $manufacturer->companyName; ?></td>
                                              <td>
                                                  <?php
                                                  $country = $CI->loginModel->getCountry($manufacturer->companyCountry);
                                                  echo isset($country[0])?$country[0]->countryName:''; ?>
                                          </tr>
                                          <?php
                                      }
                          ...
                          <div class="col-md-12">
                              <table class="table table-bordered">
                                  ...
                                  foreach ($compositions as $composition){
                                      ...
                                      <tr>
                                          <td><?php echo $c_sn++; ?></td>
                                          <td><?php echo $composition->innManual; ?></td>
                                          <td>
                                              <?php
                                              $unit = $CI->loginModel->getUnit($composition->unitId);
                                              echo $composition->strength.' ';
                                              echo isset($unit[0])?$unit[0]->unit:''; ?>
                                      </tr>
                                      <?php
                                  }
                                  }
